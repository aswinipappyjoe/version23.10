...
namespace PappyjoeMVC.Model
{
    public class Expense_model
    {
        ...
        {
            DataTable dtb = db.table("select id,expense_type,description,nameofperson,amountincome,tag_name, DATE_FORMAT(date, '%d/%m/%Y')as date from tbl_expense where Type='Income' order by id");
            return dtb;
        }
        ...
        {
            int i = db.execute("insert into tbl_expense(date,expense_type,description,amount,nameofperson,Type,amountincome,tag_name)values('" + Convert.ToDateTime(datevisitedincome).ToString("yyyy/MM/dd") + "','" + comboBoxincomacc + "','" + textBoxdescincome + "','0','" + textBoxnameofincome + "','Income','" + txtamountincome + "','"+tname+"')");
            return i;
        }
        ...
        public int submit_debit(string datevisited, string comboaccountname, string textBox_add_template, string textamount, string textperson,string tname)
        {
            int i = db.execute("insert into tbl_expense(date,expense_type,description,amount,nameofperson,Type,amountincome,tag_name)values('" + Convert.ToDateTime(datevisited).ToString("yyyy/MM/dd") + "','" + comboaccountname + "','" + textBox_add_template + "','" + textamount + "','" + textperson + "','Expense','0','"+tname+"')");
            return i;
        }
        public DataTable fill_dgv_debit()
        {
            DataTable dtb = db.table("select id,expense_type,description,amount,nameofperson,tag_name, DATE_FORMAT(date, '%d/%m/%Y')as date from tbl_expense where Type='Expense' order by id");
            return dtb;
        }
        ...
        {
            int i = db.execute("update tbl_expense set date='" + Convert.ToDateTime(datevisitedincome).ToString("yyyy/MM/dd") + "',expense_type='" + comboBoxincomacc + "',description='" + textBoxdescincome + "',amountincome='" + txtamountincome + "',nameofperson='" + textBoxnameofincome + "',Type='Income',amount='0',tag_name='"+tname+"' where id='" + Incom_ID + "'");
            return i;
        }
        public int Update_dgv_debit(int rowindex, string datevisited, string comboaccountname, string textBox_add_template, string textamount, string textperson,string tname)
        {
            int i = db.execute("update tbl_expense set date='" + Convert.ToDateTime(datevisited).ToString("yyyy/MM/dd") + "',expense_type='" + comboaccountname + "',description='" + textBox_add_template + "',amount='" + textamount + "',nameofperson='" + textperson + "',Type='Expense',amountincome='0',tag_name='"+tname+"' where id='" + rowindex + "'");
            return i;
        }
        ...
        {
            DataTable dt = db.table("select * from tbl_expense_tag ");
            return dt;
        }
        ...
        {
            DataTable d = db.table("select * from tbl_expense_tag where exp_type='Dr'");
            return d;
        }
        public DataTable tag_income_checked()
        {
            DataTable d = db.table("select * from tbl_expense_tag where exp_type='Cr'");
            return d;
        }
        public DataTable expense_search(string account, string type, string tname, string date1, string date2)
        {
            DataTable dt_templates = db.table("select id,date,Type,nameofperson,expense_type,amount+amountincome as amountbind,amount,description,amountincome from tbl_expense where expense_type like '%" + account + "%' and Type='" + type + "' and tag_name='" + tname + "'and date between '" + date1 + "' and '" + date2 + "' ");///aswini
            return dt_templates;
        }
        public DataTable expense_search2(string type, string date1, string date2)
        {
        ...
        {
            DataTable dt_templates = db.table("select id,date,Type,nameofperson,expense_type,amount+amountincome as amountbind,amount,description,amountincome from tbl_expense where expense_type like '%" + account + "%' and tag_name='" + tname + "'and date between '" + date1 + "' and '" + date2 + "' "); ///aswini
            return dt_templates;
        }
        public DataTable expense_search4(string date1, string date2)
        {
        ...
        {
            DataTable dt_templates = db.table("select id,date,Type,nameofperson,expense_type,amount+amountincome as amountbind,amount,description,amountincome from tbl_expense where tag_name like '%" + tname + "%' and date between '" + date1 + "' and '" + date2 + "' "); ///aswini
            return dt_templates;
        }
        public DataTable expense_search7(string type, string tname, string date1, string date2)
        {
            DataTable dt_templates = db.table("select id,date,Type,nameofperson,expense_type,amount+amountincome as amountbind,amount,description,amountincome from tbl_expense where  Type='" + type + "' and tag_name like'%" + tname + "%' and date between '" + date1 + "' and '" + date2 + "' ");///aswini
            return dt_templates;
        }
