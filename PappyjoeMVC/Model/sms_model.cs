...
namespace PappyjoeMVC.Model
{
    public class SMS_model
    {
        ...
        public string SendSMS(string User, string password, string RID, string Mobile_Number, string Message, string SID, string Sname, string scheduledDate, string systemdate)
        {
            //user=drtoms&passwd=gknco113&RID=10&mobilenumber=9037851234&message=hi dear&SenderName=DRTOMS&schedulerName=AS1&ScheduledDateTime=20/11/2015 12:10:00 PM&systemcurrenttime=20/11/2015 10:40:00 AM&interval=0


            System.Object stringpost = "user=" + User + "&passwd=" + password + "&RID=" + RID + "&mobilenumber=" + Mobile_Number + "&message=" + Message + "&SenderName=" + SID + "&schedulerName=" + Sname + "&ScheduledDateTime=" + scheduledDate + "&systemcurrenttime=" + systemdate + "&interval=0";
            ...
            {
                string stringResult = null;
                objWebRequest = (HttpWebRequest)WebRequest.Create("http://www.smscountry.com/APIEditReminder.asp?");
                objWebRequest.Method = "POST";
        ...
        public string SendSMS(string User, string password, string RID)
        {
            //user=drtoms&passwd=gknco113&RID=10&mobilenumber=9037851234&message=hi dear&SenderName=DRTOMS&schedulerName=AS1&ScheduledDateTime=20/11/2015 12:10:00 PM&systemcurrenttime=20/11/2015 10:40:00 AM&interval=0


            System.Object stringpost = "User=" + User + "&passwd=" + password + "&RID=" + RID + "";
            //string functionReturnValue = null;
            //functionReturnValue = "";
            HttpWebRequest objWebRequest = null;
            HttpWebResponse objWebResponse = null;
            ...
            {
                string stringResult = null;
                objWebRequest = (HttpWebRequest)WebRequest.Create("https://www.smscountry.com/APIDeleteReminder.asp?");
                objWebRequest.Method = "POST";
