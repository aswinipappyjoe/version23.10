...
namespace PappyjoeMVC.Model
{
    public class Add_New_Patient_model
    {
        ...
        public int Save(string _name ,string _id , string _aadhar , string _gender, string _dob , string _age ,string age2,string days, string _blood , string _accompained , string _pmobile , string _smobile , string _landline , string _email , string _street , string
       _locality , string _city , string _pincode , string _referred , string _file , string _admit, string _doctor , string _occupation,string _nationality,string _passportno,string co,string pas_expiry_date,string cou_issu_pass,string late_visa_no,string visa_issu_contry,string lates_visa_expiry_date)
        {
            int i = db.execute("insert into tbl_patient (pt_name,pt_id,aadhar_id,gender,date_of_birth,age,age2,days,blood_group,family,relation,primary_mobile_number,secondary_mobile_number,landline_number,email_address,street_address,locality,city,pincode,date,group_id,refferedby,Opticket,Visited,doctorname,Occupation,Profile_Status,nationality,passport_no,care_of,passport_expiry_date,country_issuing_passport,latest_visa_no,visa_issuing_country,latest_visa_expiry_date)" +
      " values('" + _name + "','" + _id + "','" + _aadhar + "','" + _gender + "','" + _dob + "','" + _age + "','" + age2 + "','" + days + "','" + _blood + "','" + _accompained + "','null','" + _pmobile + "','" + _smobile + "','" + _landline + "','" + _email + "','" + _street + "'," +
      "'" + _locality + "','" + _city + "','" + _pincode + "','" + Convert.ToDateTime(DateTime.Now.Date).ToString("yyyy/MM/dd") + "','id4','" + _referred + "','" + _file + "','" + Convert.ToDateTime(_admit).ToString("yyyy/MM/dd") + "','" + _doctor + "','" + _occupation + "','Active','"+_nationality+"','"+_passportno+"','"+ co + "','" + pas_expiry_date + "','" + cou_issu_pass + "','" + late_visa_no + "','" + visa_issu_contry + "','" + lates_visa_expiry_date + "')");
            return i;
        }
