...
namespace PappyjoeMVC.Model
{
    public class LabMedical_model
    {
        ...
        public DataTable tpMain_unit_exist(string text)
        {
            DataTable Unit = db.table("select id,Name from Lab_Medi_Unit where Name='" + text + "'");
            return Unit;
        }
        ...
        {
            DataTable Normavalue = db.table("select concat(NormalValueM,',',NormalValueF) as Normalvalue from Lab_Medi_Test  where id = '" + test + "' ");
            return Normavalue;
        }
        public int Insert_mediTemplate(int Id, int MainTestId, string TestId, string Typeid, object Units, string NormalValue)//
        {
            int i = db.execute("insert into Lab_Medi_Template (Id,MainTestId,TestId,TestTypeID,Units,NormalValue)values('" + Id + "', '" + MainTestId + "','" + TestId + "','" + Typeid + "','" + Units + "','" + NormalValue + "')");//, 
            return i;
        }
