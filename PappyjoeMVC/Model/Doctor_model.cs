...
namespace PappyjoeMVC.Model
{
    public class Doctor_model
    {
        ...
        public int update_doctor(string doctor_id, string _drname, string _number, string _email, string _gender, string _year, string _about, string _path,string _logtype, string _password,string color,string regno,string activate,string fee,string followup_fee,string followup_period)
        {
            int update;
            if (_path == "")//llll
            {
                update = db.execute("update tbl_doctor set doctor_name='" + _drname + "',mobile_number='" + _number + "',email_id='" + _email + "',password='" + _password + "',gender='" + _gender + "',experience='" + _year + "',about='" + _about + "',image= null,login_type='"+_logtype+ "', registration_number='" + regno + "',calendar_color ='" + color + "',activate_login='" + activate + "', fee='" + fee + "',followup_fee ='" + followup_fee + "',  followup_period ='" + followup_period + "',availability='Available'  where id='" + doctor_id + "'");
            }
            else
            {
                update = db.execute("update tbl_doctor set doctor_name='" + _drname + "',mobile_number='" + _number + "',email_id='" + _email + "',password='"+ _password + "',gender='" + _gender + "',experience='" + _year + "',about='" + _about + "',image='" + _path + "',login_type='" + _logtype + "' , registration_number='" + regno + "',calendar_color ='" + color + "',activate_login='" + activate + "',fee= '" + fee + "',followup_fee ='" + followup_fee + "',  followup_period ='" + followup_period + "',availability='Available'   where id='" + doctor_id + "'");
            }
            return update;
        }
        ...
        public void update_logintable(string doctor, string _email, string _password,string type)
        {
            db.execute("update tbl_login set username='" + _email + "',password='" + _password + "',type='" + type + "' where dr_id='" + doctor + "' ");//and password='" + paswd + "'
        }
        public DataTable load_staffcombo()
        {
            DataTable dtb = db.table("select * from tb1_staff order by id");
            return dtb;
        ...
        {
            DataTable dtb = db.table("select doctor_name,gender,experience,about,mobile_number,email_id,password,path,login_type,activate_login,calendar_color,registration_number,fee,followup_fee,followup_period from tbl_doctor where id='" + doctor_id + "'");
            return dtb;
        }
