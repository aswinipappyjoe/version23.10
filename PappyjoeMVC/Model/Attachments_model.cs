...
namespace PappyjoeMVC.Model
{
    public class Attachments_model
    {
        ...
        {
            DataTable dt = c.table("select dr_id,patient_id,CategoryName,date,photo_name,id,path from tbl_attachments where patient_id='" + patntid + "' and CategoryName <>'Certificate' order by date,id DESC");
            return dt;
        }
        ...
        public DataTable get_certificate(string patntid)
        {
            DataTable dt = c.table("select dr_id,patient_id,CategoryName,date,photo_name,id,path from tbl_attachments where patient_id='" + patntid + "' and CategoryName='Certificate'  order by date,id DESC");
            return dt;
        }
