...
namespace PappyjoeMVC.Model
{
    public class Printout_model
    {
        ...
        public DataTable get_Inventory_printdetails()
        {
            DataTable print = db.table("select * from tbl_inventory_printsettings");
            return print;
        }
        ...
        public int save_Invdata(string _size, string _orintation, string _color, string _topmargine, string _left_margine, string _bottommargin, string _rightmargin, string includeheader, string header, string _lefttext, string _righttext, string includelogo, string logotype, string patientdetails, string medhistory, string patientno, string address, string phone, string email, string bloodgroup, string genderdob, string _footer_top, string _header_top, string _leftsign, string _rightsign)
        {
            int insert = db.execute("insert into tbl_inventory_printsettings (size,orientation,printer_type,top_margin,left_margin,bottom_margin,right_margin,include_header,header,left_text,right_text,include_logo,logo_type,patient_details,medical_history,patient,address,phone,email,blood_group,gender_dob,header_top,fullwidth_context,left_sign,right_sign) values('" + _size + "','" + _orintation + "','" + _color + "','" + _topmargine + "','" + _left_margine + "','" + _bottommargin + "','" + _rightmargin + "','" + includeheader + "','" + header + "','" + _lefttext + "','" + _righttext + "','" + includelogo + "','" + logotype + "','" + patientdetails + "','" + medhistory + "','" + patientno + "','" + address + "','" + phone + "','" + email + "','" + bloodgroup + "','" + genderdob + "','" + _footer_top + "','" + _header_top + "','" + _leftsign + "','" + _rightsign + "')");
            return insert;
        }
        ...
        public int Update_invPrint(string _size, string _orintation, string _color, string _topmargine, string _left_margine, string _bottommargin, string _rightmargin, string includeheader, string header, string _lefttext, string _righttext, string includelogo, string logotype, string patientdetails, string medhistory, string patientno, string address, string phone, string email, string bloodgroup, string genderdob, string _footer_top, string _header_top, string _leftsign, string _rightsign)
        {
            int update = db.execute("update tbl_inventory_printsettings set size='" + _size + "',orientation='" + _orintation + "',printer_type='" + _color + "',top_margin='" + _topmargine + "',left_margin='" + _left_margine + "',bottom_margin='" + _bottommargin + "',right_margin='" + _rightmargin + "',include_header='" + includeheader + "',header='" + header + "',left_text='" + _lefttext + "',right_text='" + _righttext + "',include_logo='" + includelogo + "',logo_type='" + logotype + "',patient_details='" + patientdetails + "',medical_history='" + medhistory + "',patient='" + patientno + "',address='" + address + "',phone='" + phone + "',email='" + email + "',blood_group='" + bloodgroup + "',gender_dob='" + genderdob + "',header_top='" + _footer_top + "',fullwidth_context='" + _header_top + "',left_sign='" + _leftsign + "',right_sign='" + _rightsign + "'");
            return update;
        }
        ...
        public int save_invoice(string _size1, string _orintation1, string _color1, string _topmargine1, string _left_margine1, string _bottommargin1, string _rightmargin1, string includeheader1, string header1, string _lefttext1, string _righttext1, string _lefttext2, string _righttext2 , string includelogo1, string logotype1, string patientdetails1, string medhistory1, string patientno1, string address1, string phone1, string email1, string bloodgroup1, string genderdob1, string _footer_top1, string _header_top1, string _leftsign1, string _rightsign1 )
        {
            int insert = db.execute("insert into tbl_invoice_printsettings(size,orientation,printer_type,top_margin,left_margin,bottom_margin,right_margin,include_header,header,left_text,right_text,left1_text,right1_text,include_logo,logo_type,patient_details,medical_history,patient,address,phone,email,blood_group,gender_dob,header_top,fullwidth_context,left_sign,right_sign,Doctor)  values('" + _size1 + "','" + _orintation1 + "','" + _color1 + "','" + _topmargine1 + "','" + _left_margine1 + "','" + _bottommargin1 + "','" + _rightmargin1 + "','" + includeheader1 + "','" + header1 + "','" + _lefttext1 + "','" + _righttext1 + "','" + _lefttext2 + "','" + _righttext2 + "','" + includelogo1 + "','" + logotype1 + "','" + patientdetails1 + "','" + medhistory1 + "','" + patientno1 + "','" + address1 + "','" + phone1 + "','" + email1 + "','" + bloodgroup1 + "','" + genderdob1 + "','" + _footer_top1 + "','" + _header_top1 + "','" + _leftsign1 + "','" + _rightsign1 + "')");
            return insert;
        }
