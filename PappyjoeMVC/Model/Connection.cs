...
namespace PappyjoeMVC.Model
{
    public class Connection
    {
        ...
        private void Initialize()
        {
            ...
            connectionString = "SERVER=" + serve + ";" + "DATABASE=" + database + ";" + "UID=" + uid + ";" + "PASSWORD=" + password + "; Charset=utf8; convert zero datetime=True";
            con = new MySqlConnection(connectionString);
            conSP = new MySqlConnection(connectionString);
            PappyjoeMVC.Model.Connection.MyGlobals.trans_connectionstring = connectionString;
        }
        ...
        public void trans_openconnection()
        {
            int i = 0;
            if (this.OpenConnection() == true)
            {
        ...
        public DataTable trans_table(string s, MySqlConnection mcon, MySqlTransaction trans)
        {
            DataTable dt = new DataTable();
            MySqlCommand cmd = new MySqlCommand(s, mcon, trans);
            MySqlDataAdapter da = new MySqlDataAdapter(cmd);
            da.Fill(dt);
            return dt;
        }
        public int trans_execute(string s, MySqlConnection mcon, MySqlTransaction trans)
        {
            int i = 0;
            MySqlCommand cmd = new MySqlCommand(s, mcon, trans);
            i = cmd.ExecuteNonQuery();
        ...
        public string trans_scalar(string s, MySqlConnection mcon, MySqlTransaction trans)
        {
            string r = "";
            MySqlCommand cmd = new MySqlCommand(s, mcon, trans);
            //con.Open();
        ...
        public static class MyGlobals
        {
            ...
            public static string trans_connectionstring;
