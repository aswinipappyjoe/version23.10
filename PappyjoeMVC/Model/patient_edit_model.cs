...
namespace PappyjoeMVC.Model
{
    public class Patient_Edit_model
    {
        ...
        public int update(string patname, string patId, string aadhar, string Gender, string age,string age2,string days, string Dob, string blood, string family, string Pmob, string Smob, string Landline, string email, string street, string locality, string city, string pin, string refferedby, string opticket, string Visited, string occupation, string doctername, string nationality, string passport,string co,string pt_id,string pas_expiry_date, string cou_issu_pass, string late_visa_no, string visa_issu_contry, string lates_visa_expiry_date)
        {
            int i = db.execute("update tbl_patient set pt_name='" + patname + "',pt_id='" + patId + "',aadhar_id='" + aadhar + "',gender='" + Gender + "',age='" + age + "', age2='" + age2 + "',days='" + days + "', date_of_birth='" + Dob + "',blood_group='" + blood + "',family='" + family + "',primary_mobile_number='" + Pmob + "',secondary_mobile_number='" + Smob + "',landline_number='" + Landline + "',email_address='" + email + "',street_address='" + street + "',locality='" + locality + "',city='" + city + "',pincode='" + pin + "',group_id='',refferedby='" + refferedby + "',Opticket='" + opticket + "',Visited='" + Visited + "',Occupation='" + occupation + "',doctorname='" + doctername + "',nationality='"+nationality+"',passport_no='"+passport+ "',care_of='"+co+ "',passport_expiry_date='" + pas_expiry_date + "',country_issuing_passport='" + cou_issu_pass + "',latest_visa_no='" + late_visa_no + "',visa_issuing_country='" + visa_issu_contry + "',latest_visa_expiry_date='" + lates_visa_expiry_date + "'  where id='" + pt_id + "'");
            return i;
        }
