...
namespace PappyjoeMVC.Controller
{
    public class Procedure_Catalog_controller
    {
        ...
        {
            DataTable dt = _model.FormLoad_ShMre(limit);
            return dt;
        }
        ...
        {
            int i = _model.save_addprocedure(_procName, _procost,_sac, _comboCategory, _notes);
            return i;
        }
        ...
        {
            int i = _model.update_addprocedure(_procName, _procost,_sac, _comboCategory, _notes,pro_id);
            return i;
        }
        ...
        {
            _model.save_enablecost(cost);
        }
        public DataTable get_enablecost()
        {
            DataTable dtb = _model.get_enablecost();
            return dtb;
        }
        public void update_enablecost(string cost)
        {
            _model.update_enablecost(cost);
        }
    }
}
