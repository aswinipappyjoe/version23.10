   ...
   public class MainCalendar_Controller
    {
        ...
        {
            string id = model.Get_staff_type(dr_id);
            return id;
        }
        ...
        {
            DataTable dtb = model.doctor_appointments_admin_load(startDateTime, startDateTime1);
            return dtb;
        }
        public DataTable all_dctr_appointment_lil()
        {
            DataTable dtb = model.all_dctr_appointment_lil();
            return dtb;
        }
        ...
        {
            DataTable dtb = model.all_dctr_appointment_daywise(startDateTime, startDateTime1);
            return dtb;
        }
        ...
        {
            model.update_appointment_status(ContextEvent,reason);
        }
