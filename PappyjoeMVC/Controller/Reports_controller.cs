...
namespace PappyjoeMVC.Controller
{
    public class Reports_controller
    {
        ...
        public DataTable inv_main(string date1)
        {
            DataTable dt = _model.invoice_main(date1);
            return dt;
        }
        public DataTable invoice_main_doctor_wise(string date1, string dr_id)
        {
            DataTable dt = _model.invoice_main_doctor_wise(date1, dr_id);
            return dt;
        }
        ...
        {
            DataTable dt = _model.reciept(date1);
            return dt;
        }
        ...
        {
            DataTable dt = _model.Patient_invMain(date1);
            return dt;
        }
        ...
        {
            DataTable dt = _model.EMR_invMain(date1);
            return dt;
        }
        ...
        {
            DataTable dt = _model.expence_checked(date1, type);
            return dt;
        }
        public DataTable expense_income_notChecked(string date1)
        {
            DataTable dt = _model.expence_income_notChecked(date1);
            return dt;
        }
        ...
        {
            DataTable dt = _model.get_batch_stock(itemcode);
            return dt;
        }
        public DataTable stock_grossvalue(string itemcode)
        {
            DataTable dt = _model.stock_grossvalue(itemcode);
            return dt;
        }
