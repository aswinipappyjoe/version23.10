...
namespace PappyjoeMVC.Controller
{
    public class Add_Receipt_controller
    {
        ...
        {
            DataTable dtb = _model.dt_due_clear(invno, ptid);
            return dtb;
        }
        ...
        {
            _model.update_due(total, invoice_no, patient_id);
        }
        ...
        {
            int inv = _model.save_payment(advance, receipt_no, amount_paid, invoice_no, procedure_name, mode_of_payment, pt_id, payment_date, dr_id, payment_due, total, cost, pt_name, invoicemainid);
            return inv;
        }
