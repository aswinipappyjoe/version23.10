...
namespace PappyjoeMVC.Controller
{
    public class Invoice_controller
    {
        ...
        public int save_log(string log_usrid, string log_type, string log_descriptn, string t, string b, string log_stage)
        {
            int j = Add_inv_model.save_log(log_usrid, log_type, log_descriptn, t, b, log_stage);
            return j;
        }
        ...
        {
            DataTable dt_invoice_main = Add_inv_model.Load_invoice_mainDetails_count(patient_id,count);
            return dt_invoice_main;
        }
        ...
        public DataTable get_invoiceDetails(string mainid)
        {
            DataTable dt_pt_sub = Add_inv_model.get_invoiceDetails_sac(mainid);
            return dt_pt_sub;
        }
        ...
        public DataTable Get_patient_id_name_gender(string patient_id)
        {
            ...
            {
                DataTable dtp = Add_inv_model.Get_companynameNo();
                return dtp;
            }
        public DataTable remindersms()
        {
            DataTable smsreminder = Add_inv_model.remindersms();
            return smsreminder;
        }
