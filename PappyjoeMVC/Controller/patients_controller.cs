...
namespace PappyjoeMVC.Controller
{
    public class Patients_controller
    {
        ...
        {
            DataTable dtb = _model.all_Patients_search(pt_id);
            return dtb;

        }
        public DataTable patient_showmore(int count)
        {
            DataTable dtb = _model.patient_showmore(count);
            return dtb;
        }
        public DataTable Get_all_Patients_count()
        {
            DataTable dtb = _model.Get_all_Patients_count();
            return dtb;
        }
        public DataTable get_nnotify_count()
        {
            DataTable dtn = _model.get_nnotify_count();
            return dtn;
        }
        public DataTable get_lab_notify()
        {
            DataTable dtl = _model.get_lab_notify();
            return dtl;
        }
        ...
        {
            DataTable rs_log = _model.log_action();
            return rs_log;

        }
        public DataTable log_search_action(string name)
        {
            DataTable rs_log = _model.log_search_action(name);
            return rs_log;

        }
        public DataTable log_details_count(string count)
        {
            DataTable rs_log = _model.log_details_count(count);
            return rs_log;
        }
        public DataTable log_search(string name)
        {
            DataTable rs_log = _model.log_search(name);
            return rs_log;
        }
        public DataTable log_search_wit_action(string name, string action)
        {
            DataTable rs_log = _model.log_search_wit_action(name, action);
            return rs_log;
        }
        ...
        {
            DataTable rs_log = _model.log_date(id);
            return rs_log;
        }
        ...
        {
            DataTable log = _model.pur_log_detail(id);
            return log;
        }
        //bhj
        public DataTable Get_all_ipPatients()
        {
            DataTable dtb = _model.Get_all_ipPatients();
            return dtb;
        }
        public DataTable Get_all_dischargePatients()
        {
            DataTable dtb = _model.Get_all_dischargePatients();
            return dtb;
        }
    }
}
