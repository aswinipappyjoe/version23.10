   ...
   public class SimpleAppointment_controller
    {
        ...
        {
            Ainv_model.Save_tbl_completed_procedures(plan_main_id, patient_id, procedure_id, procedure_name, quantity, cost, discount_type, discount, total, discount_inrs, note, dr_id, completed_id, tooth, lab);
        }
