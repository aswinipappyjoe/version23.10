...
namespace PappyjoeMVC.Controller
{
    public class Manufacture_controller
    {
        ...
        {
            DataTable dtb = _model.manufacture_name(name);
            return dtb;
        }
        public DataTable manufacture_code(string code)
        {
            DataTable dtb = _model.manufacture_code(code);
            return dtb;
        }
        public DataTable manufacture_phn(string phn)
        {
            DataTable dtb = _model.manufacture_phn(phn);
            return dtb;
        }
        public DataTable search_mnfctr(string id)
        {
            DataTable dt = _model.mnfctr(id);
            return dt;
        }
    }
}
