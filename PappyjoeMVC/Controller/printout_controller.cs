...
;        public DataTable Get_practice_details()
        ...
        public DataTable Get_inventory_id()
        {
            DataTable dt = mdl.get_Inventory_printdetails();
            return dt;
        }
        ...
        public int save_invPrint(string _size, string _orintation, string _color, string _topmargine, string _left_margine, string _bottommargin, string _rightmargin, string includeheader, string header, string _lefttext, string _righttext, string includelogo, string logotype, string patientdetails, string medhistory, string patientno, string address, string phone, string email, string bloodgroup, string genderdob, string _footer_top, string _header_top, string _leftsign, string _rightsign)
        {
            int i = mdl.save_Invdata(_size, _orintation, _color, _topmargine, _left_margine, _bottommargin, _rightmargin, includeheader, header, _lefttext, _righttext, includelogo, logotype, patientdetails, medhistory, patientno, address, phone, email, bloodgroup, genderdob, _footer_top, _header_top, _leftsign, _rightsign);
            return i;
        }
        ...
        {
            int i = mdl.Update_invPrint(_size, _orintation, _color, _topmargine, _left_margine, _bottommargin, _rightmargin, includeheader, header, _lefttext, _righttext, includelogo, logotype, patientdetails, medhistory, patientno, address, phone, email, bloodgroup, genderdob, _footer_top, _header_top, _leftsign, _rightsign);
            return i;
        }
        //invoice
