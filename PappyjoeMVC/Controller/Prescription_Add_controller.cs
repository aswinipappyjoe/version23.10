...
namespace PappyjoeMVC.Controller
{
    public class Prescription_Add_controller
    {
        ...
        {
            DataTable dtb = _model.check_expiry_date(ItemCode);
            return dtb;
        }
        ...
        public DataTable drug_search(string search, bool chkbool)
        {
            DataTable dtb = _model.drug_search(search, chkbool);
            return dtb;
        }
        ...
        public DataTable drug_load(bool ge)
        {
            DataTable dtb = _model.drug_load(ge);
            return dtb;
        }
    }
}
