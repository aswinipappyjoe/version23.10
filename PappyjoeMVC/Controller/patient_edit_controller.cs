...
namespace PappyjoeMVC.Controller
{
    public class Patient_Edit_controller
    {
        ...
        {
            int i = _model.update( patname,  patId,  aadhar,  Gender,  age, age2,days,  Dob,  blood,  family,  Pmob,  Smob,  Landline,  email,  street,  locality,  city,  pin,  refferedby,  opticket,  Visited,  occupation,  doctername,nationality, passport, co, pt_id, pas_expiry_date, cou_issu_pass, late_visa_no, visa_issu_contry, lates_visa_expiry_date);
            return i;
        }
