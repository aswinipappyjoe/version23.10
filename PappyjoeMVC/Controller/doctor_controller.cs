...
namespace PappyjoeMVC.Controller
{
    public class Doctor_Controller
    {
        ...
        {
            int i = _model.update_doctor(doctor_id, _drname, _number, _email, _gender, _year, _about, _path,_logtype, _password, color, regno, activate, fee, followup_fee, followup_period);
            return i;
        }
        ...
        {
            DataTable dt = _model.load_staffcombo();
            return dt;
        }
        ...
        {
            _model.update_logintable( doctor,  _email,  _password,type);
        }
        //clinical details
