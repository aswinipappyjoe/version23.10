...
namespace PappyjoeMVC.Controller
{
    public class Ledger_controller
    {
        ...
        public DataTable dt_advance(/*string invdate*/)
        {
            DataTable dt = _model.dt_advance(/*invdate*/);
            return dt;
        }
        public DataTable getall_advance(string pt_id)
        {
            DataTable dtb = _model.getall_advance(pt_id);
            return dtb;
        }
        public DataTable Adv_return(string pt_id)
        {
            DataTable dtb = _model.Adv_return(pt_id);
            return dtb;
        }
    }
}
