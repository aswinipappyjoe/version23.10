...
namespace PappyjoeMVC.Controller
{
    public class Add_New_patient_controller
    {
       ...
       _locality, string _city, string _pincode, string _referred, string _file, string _admit, string _doctor, string _occupation,string _nationality,string _passportno,string co, string pas_expiry_date, string cou_issu_pass, string late_visa_no, string visa_issu_contry, string lates_visa_expiry_date)
        {
            int i = _model.Save(_name, _id, _aadhar, _gender, _dob, _age,age2,days, _blood, _accompained, _pmobile, _smobile, _landline, _email, _street, _locality, _city, _pincode, _referred, _file, _admit, _doctor, _occupation,_nationality,_passportno, co, pas_expiry_date, cou_issu_pass, late_visa_no,  visa_issu_contry, lates_visa_expiry_date);
            return i;
        }
        ...
        {
            int j = mdl.save_log(log_usrid, log_type, log_descriptn, logdate, logtime, log_stage, typeid);
            return j;
        }
