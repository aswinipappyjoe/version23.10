...
{
    [DefaultEvent("on_SelectedIndexChanged")]
    class custome_combobox : UserControl
    {
        //fields
        ...
        //events
        public event EventHandler on_SelectedIndexChanged;//default event
        ...
        private void comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (on_SelectedIndexChanged != null)
                on_SelectedIndexChanged.Invoke(sender, e);
