...
namespace PappyjoeMVC.RJControls
{
    public partial class UserControl_label : UserControl
    {
        ...
        private Color placeholdercolor = Color.DarkBlue;
        ...
        //    get
        //    {
        //        return label1.Multiline;
        //    }
        //    set
        //    {
        //        label1.Multiline = value;
        //        //this.Invalidate();
        //    }
        //}
        [Category("RJ Code Advanced")]
        ...
        {
            if (string.IsNullOrWhiteSpace(label1.Text) && placeholderText != "")
            {
                //Isplaceholder = true;
        ...
        private void UpdateControlHeight()
        {
            ...
            label1.MinimumSize = new Size(0, txthieght);
                this.Height = label1.Height + this.Padding.Top + this.Padding.Bottom;
            //}
        }
        private void SetTextBoxRoundedRegion()
        {
            ...
            //else
            //{
                pathTxT = GetFigurePath(label1.ClientRectangle, bordersize * 2);
            label1.Region = new Region(pathTxT);
            //}
        }
