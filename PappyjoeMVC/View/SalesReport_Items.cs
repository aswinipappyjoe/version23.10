    ...
    public partial class SalesReport_Items : Form
    {
        ...
        private void SalesReport_Items_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                DGV_ITEMS.Columns[3].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleLeft;
                ...
                DGV_ITEMS.Columns[3].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            try
            {
                if (dtb.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtb.Rows.Count; i++)
                    {
                        ...
                        DGV_ITEMS.Rows[i].Cells["Item_Code"].Value = dtb.Rows[i]["ItemCode"].ToString();
                        ...
                        DGV_ITEMS.Rows[i].Cells["GST"].Value =Convert.ToDecimal( dtb.Rows[i]["GST"].ToString()).ToString("##.00");
                        ...
                        DGV_ITEMS.Rows[i].Cells["c_disc"].Value = dtb.Rows[i]["Discount"].ToString();
            ...
            try
            {
                if (DGV_ITEMS.Rows.Count > 0)
                {
                    ...
                    if (DGV_ITEMS.Rows.Count > 0)
                    {
                        ...
                        sWrite.WriteLine("    <td align='center' width='6%' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Geneva, Segoe UI' SIZE=2> Discount</font></td>");
                        ...
                        for (int c = 0; c < DGV_ITEMS.Rows.Count; c++)
                        {
                            ...
                            sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black FACE='Geneva, Segoe UI' SIZE=1>" + DGV_ITEMS.Rows[c].Cells["c_disc"].Value.ToString() + "</font></td>");
                        ...
                        sWrite.WriteLine("<td align='right'  colspan=11 ><FONT COLOR=black FACE='Geneva, Segoe UI' SIZE=1>INR " + TxttotalCost.Text + " </font></td>");
                        sWrite.WriteLine("</tr>");
                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("<td align='right'  colspan=10 ><FONT COLOR=black FACE='Geneva, Segoe UI' SIZE=1> Grand Total :</font></td>");
                        sWrite.WriteLine("<td align='right'  colspan=11 ><FONT COLOR=black FACE='Geneva, Segoe UI' SIZE=1>INR " + Txtgrandtotal.Text + " </font></td>");
                        sWrite.WriteLine("</tr>");
                        sWrite.WriteLine("<tr>");
                        ...
                        sWrite.WriteLine("</tr>");
                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("<td align='right'  colspan=10 ><FONT COLOR=black FACE='Geneva, Segoe UI' SIZE=1> GST :</font></td>");
        ...
        public void calculations()
        {
            try
            {
                ...
                if (DGV_ITEMS.Rows.Count > 0)
                {
                    ...
                    Txt_totalItems.Text = total_inv.ToString("##.00");
                    if (TotalIgst > 0)
                    {
