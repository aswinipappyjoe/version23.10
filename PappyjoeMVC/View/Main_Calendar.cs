...
namespace PappyjoeMVC.View
{
    ...
    public class Main_Calendar : System.Windows.Forms.Form
    {
        ...
        public Main_Calendar(string text)
        {
            reason = text;
        }
        ...
        public void gridbinddoctors()
        {
            ...
            dataGridViewdoctor.Columns[1].Width = 130;// 175;   
            ...
            dataGridViewdoctor.EnableHeadersVisualStyles = false;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.mnuContextEditEvent.Text = "";
            // 
            // mnuContextDeleteEvent
            // 
            this.mnuContextDeleteEvent.Index = 1;
            this.mnuContextDeleteEvent.Text = "";
            // 
            // toolBar1
            // 
            ...
            this.toolBar1.Size = new System.Drawing.Size(1362, 28);
            ...
            // imlToolbarIcons
            // 
            this.imlToolbarIcons.ColorDepth = System.Windows.Forms.ColorDepth.Depth8Bit;
            this.imlToolbarIcons.ImageSize = new System.Drawing.Size(16, 16);
            this.imlToolbarIcons.TransparentColor = System.Drawing.Color.Transparent;
            // 
            // mainMenu1
            // 
            ...
            this.labelPane.Location = new System.Drawing.Point(0, 28);
            ...
            this.labday.Location = new System.Drawing.Point(650, 6);
            ...
            this.labweek.Location = new System.Drawing.Point(594, 6);
            ...
            this.lblCalendar.Location = new System.Drawing.Point(199, 2);
            ...
            this.wndCalendarControl.Location = new System.Drawing.Point(196, 52);
            ...
            this.wndCalendarControl.Size = new System.Drawing.Size(908, 448);
            ...
            this.dataGridViewdoctor.Location = new System.Drawing.Point(9, 50);
            ...
            this.dataGridViewdoctor.Size = new System.Drawing.Size(179, 309);
            ...
            "Category",
            "Doctors"});
            this.combodoctors.Location = new System.Drawing.Point(9, 0);
            ...
            this.combodoctors.Visible = false;
            // 
            // panel2
            // 
            ...
            this.panel2.Location = new System.Drawing.Point(1104, 52);
            this.panel2.Name = "panel2";
            this.panel2.Size = new System.Drawing.Size(258, 448);
            ...
            this.dataGridViewAppointment.Size = new System.Drawing.Size(257, 378);
        ...
        private void UpdateDateLabel()
        {
            ...
            else if (wndCalendarControl.ActiveView.DaysCount > 1)
            {
                ...
                date1 = DateLabelFrom; date2 = DateLabelTo;
                lblDate.Text = DateLabelFrom.ToLongDateString() + " - " + DateLabelTo.ToLongDateString();
            }
        }
        public DateTime date1 = DateTime.Now.Date; public DateTime date2 = DateTime.Now.Date;
        ...
        private void frmMain_Load(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                staff_type = this.cntrl.Get_staff_type(doctor_id);
                if (int.Parse(i) > 0)
                {
                    dr_wise_apt = true;
                    if (staff_type == "DOCTOR")
            ...
            //    gridbinddoctors();
            //}
            AddTestEvents_load(true);
           
            //DataTable data = this.ctrlr.LoadData();
            //if (dataGridViewdoctor.Rows.Count > 0)
            //{
            //    //flag = true;
            //    //LoadData(data);
            ...
            //    };
            //    dataGridViewdoctor.Columns.Add(check);
            //    check.Width = 30;
        ...
        private void AddTestEvents_load(Boolean bCreateDefaultProvider)
        {
            ...
            if (doctor_id == "1")
            {
                dt = this.cntrl.doctor_appointments_admin_load(Convert.ToDateTime( thisWeekStart),Convert.ToDateTime( thisWeekEnd));// all_dctr_appointment_lil();
            }
            else
            {
                if (staff_type == "DOCTOR")
                {
                    dt = this.cntrl.doctor_appointments(Convert.ToDateTime(thisWeekStart), Convert.ToDateTime(thisWeekEnd),doctor_id);// get_dctr_wise_appointment(doctor_id);
                }
                else
                {
                    dt = this.cntrl.doctor_appointments_admin_load(Convert.ToDateTime(thisWeekStart), Convert.ToDateTime(thisWeekEnd));
                }
            }
        ...
        private void AddTestEvents(Boolean bCreateDefaultProvider)
        {
            ...
            if (doctor_id == "1")
            {
               dt= this.cntrl.all_dctr_appointment_lil();
            }
            else
            {
                if (staff_type == "DOCTOR")
        ...
        private void AddTestEvents_month(Boolean bCreateDefaultProvider)
        {
            CalendarDataProvider pCalendarData = wndCalendarControl.DataProvider;
            if (bCreateDefaultProvider)
            {
        ...
        private void mnuContextCancelEvent_Click(object sender, System.EventArgs e)
        {
            ...
            //{
                ...
                {
                    wndCalendarControl.DataProvider.DeleteEvent(ContextEvent);
                    this.cntrl.update_appointment_status(ContextEvent.Body,reason);
                    ...
                    if (sms.Rows.Count > 0)
                    {
                        ...
                        if (tl_appoitment.Rows.Count > 0)
                        {
                            ...
                            if (pat.Rows.Count > 0)
                            {
                                ...
                                string text = "Dear " + tl_appoitment.Rows[0]["pt_name"].ToString() + " " + ", Your appointment for " + tl_appoitment.Rows[0]["plan_new_procedure"].ToString() + " has been cancelled..  Regards " + clnc + "," + contact_no;
                                a.SendSMS(smsName, smsPass, number, text,type);
                                this.cntrl.insert_sms(tl_appoitment.Rows[0]["pt_id"].ToString(), tl_appoitment.Rows[0]["pt_name"].ToString(), tl_appoitment.Rows[0]["plan_new_procedure"].ToString(), clnc);
                            }
                        }
                    }
                    listAppointment("0"); 
        ...
        private void AddTestEvents_week_viewchanged(Boolean bCreateDefaultProvider)
        {
            CalendarDataProvider pCalendarData = wndCalendarControl.DataProvider;
            if (bCreateDefaultProvider)
            {
            ...
            if (doctor_id == "1")
            {
                dt = this.cntrl.admin_appointments(date1, date2);// all_dctr_appointment();
            }
            else
            {
                if (dr_wise_apt == false)
        ...
        private void wndCalendarControl_ViewChanged(object sender, EventArgs e)
        {
            ...
            CheckViewItems();
            if (dayview == false)
                AddTestEvents_week_viewchanged(true);
            //AddTestEvents_week_viewchanged(true);
        }
        ...
        private void dataGridViewAppointment_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewAppointment.RowCount > 0)
            {
                ...
                else if (e.ColumnIndex == 4)
                {
                    ...
                    {
                        string id1 = "";
                        var form2 = new Fasttrack_window_New();//     new SimpleAppointment();
                        ...
                        row_Val = e.RowIndex;
                        form2.doctor_id = dtdr.Rows[0]["dr_id"].ToString();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (pat_idForEdit != "0")
            {
                var form2 = new Patient_Profile_Details(); //Patient_Profile_Edit
                form2.doctor_id = doctor_id;
        ...
        {
            var form2 = new appoinment_cancellation_reason();
            form2.ShowDialog();
            if(reason== "Cancel")
            {
        ...
        private void dataGridViewdoctor_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
             if (e.ColumnIndex == 3)
            {
                ...
                ////DataGridViewCheckBoxCell chk = (DataGridViewCheckBoxCell)row.Cells[3];
                ////chk.Value = true;
                //if (dataGridViewdoctor.CurrentCell is DataGridViewCheckBoxCell)
                //    dataGridViewdoctor.CommitEdit(DataGridViewDataErrorContexts.Commit);
                //bool value = Convert.ToBoolean(dataGridViewdoctor.Rows[e.RowIndex].Cells[e.ColumnIndex].EditedFormattedValue);
                dataGridViewdoctor.CurrentCell.Selected = true;

            }
        }

        private void dataGridViewdoctor_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            dataGridViewdoctor.CurrentCell.Selected = false;
        }
