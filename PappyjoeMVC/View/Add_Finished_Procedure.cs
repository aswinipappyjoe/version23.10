...
namespace PappyjoeMVC.View
{
    public partial class Add_Finished_Procedure : Form
    {
        ...
        private void AddFinishedprocedure_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (treatment_plan != "")
                {
                    ...
                    lab_TCostINR.Text = totalcost.ToString("0.00"); //String.Format("{0:C0}", totalcost);
                    Lab_DiscountTotalINR.Text = totaldiscount.ToString("0.00"); // String.Format("{0:C0}", totaldiscount);
                    lab_GTotalINR.Text = totalgrand.ToString("0.00"); // String.Format("{0:C0}", totalgrand);
                }
                ...
                if (dt_enablecost.Rows.Count > 0)
                {
                    if (dt_enablecost.Rows[0][1].ToString() == "Yes")
                    {
                        ...
                        label5.Visible = true;
                        lab_addDiscount.Visible = true;
                        //Cmb_Discount.Visible = true;
                        //txt_Discount.Visible = true;
                        label6.Visible = true;
                        Lab_ToatlValue.Visible = true;//
                        proceduretreatgrid.Columns[2].Visible = true;
                        proceduretreatgrid1.Columns["Column11"].Visible = true;
                        proceduretreatgrid1.Columns["Column12"].Visible = true;
                        proceduretreatgrid1.Columns["Column14"].Visible = true;
                        proceduretreatgrid1.Columns["Column13"].Visible = true;
                    }
                    else
                    {
                        ...
                        Lab_ToatlValue.Visible = false;//
                        proceduretreatgrid.Columns[2].Visible = false;
                        proceduretreatgrid1.Columns["Column11"].Visible = false;
                        proceduretreatgrid1.Columns["Column12"].Visible = false;
                        proceduretreatgrid1.Columns["Column14"].Visible = false;
                        proceduretreatgrid1.Columns["Column13"].Visible = false;
                    }
                }
            ...
            try
            {
                ...
                if (e.RowIndex >= 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        Lab_ToatlValue.Text = Convert.ToString(Convert.ToDecimal(dt.Rows[0]["cost"].ToString()));
                    ...
                    if (dt_treatment.Rows.Count > 0)
                    {
                        ...
                        Lab_ToatlValue.Text = Convert.ToString(Convert.ToDecimal(dt_treatment.Rows[0]["total"].ToString()));
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (check_planid == 0)
                    {
                        ...
                        proceduretreatgrid1.Rows.Add(id, servicetext.Text, txt_qty.Text, txt_Cost.Text, dis, Cmb_Discount.Text, Lab_ToatlValue.Text, discounttotal, "", dr_id, Cmb_Discount.Text, RTB_Addnotes.Text, "DEL", lab_teethValues.Text, plan_p_id, DTP_Date.Value.ToString("yyyy-MM-dd"));
                        Decimal totalcost = 0;
                        Decimal totaldiscount = 0;
                        Decimal totalgrand = 0;
                        for (int i = 0; i < proceduretreatgrid1.Rows.Count; i++)
            ...
            try
            {
                if (e.ColumnIndex == 12 && e.RowIndex > -1)
                {
                    if (MessageBox.Show("Delete this Treatment.. Confirm?", "Remove Treatment", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        ...
                        lab_TCostINR.Text = String.Format("{0:C00}", totalcost);
                        Lab_DiscountTotalINR.Text = String.Format("{0:C00}", totaldiscount);
                        lab_GTotalINR.Text = String.Format("{0:C00}", totalgrand);
                    }
                }
            }
            catch (Exception ex)
        ...
        private void savebut_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (proceduretreatgrid1.Rows.Count > 0)
                {
                    for (int ii = 0; ii < proceduretreatgrid1.Rows.Count; ii++)
                    {
                        ...
                        if (dt_pt.Rows.Count == 0)
                        {
                            this.cntrl.save_completed_id(Convert.ToDateTime(DTP_Date.Value.ToString()).ToString("yyyy-MM-dd") , patient_id);//Convert.ToDateTime(proceduretreatgrid1["t_date", ii].Value.ToString()).ToString("yyyy-MM-dd")
                        ...
                        j_Review = j;
                        this.cntrl.save_completed_items(j, patient_id, proceduretreatgrid1[0, ii].Value.ToString(), proceduretreatgrid1[1, ii].Value.ToString(), proceduretreatgrid1[2, ii].Value.ToString(), proceduretreatgrid1[3, ii].Value.ToString(), proceduretreatgrid1[5, ii].Value.ToString(), proceduretreatgrid1[4, ii].Value.ToString(), proceduretreatgrid1[6, ii].Value.ToString(), proceduretreatgrid1[7, ii].Value.ToString(), proceduretreatgrid1[11, ii].Value.ToString(), Convert.ToDateTime(proceduretreatgrid1["t_date", ii].Value.ToString()).ToString("yyyy-MM-dd") , Cmb_Doctor.SelectedValue.ToString(), proceduretreatgrid1[14, ii].Value.ToString(), proceduretreatgrid1[13, ii].Value.ToString());//proceduretreatgrid1[15, ii].Value.ToString()
                        ...
                        this.cntrl.save_log(doctor_id, "Finished Procedure", " Add Finished Procedure", dt1, Convert.ToString(Timeonly.ToString("hh:mm tt")), "Add",j.ToString());
                    }
            ...
            //            }
            //            j_Review = j;
            //            this.cntrl.save_completed_items(j, patient_id, proceduretreatgrid1[0, ii].Value.ToString(),proceduretreatgrid1[1, ii].Value.ToString() ,proceduretreatgrid1[2, ii].Value.ToString(),proceduretreatgrid1[3, ii].Value.ToString(),proceduretreatgrid1[5, ii].Value.ToString(),proceduretreatgrid1[4, ii].Value.ToString() ,proceduretreatgrid1[6, ii].Value.ToString(),proceduretreatgrid1[7, ii].Value.ToString() ,proceduretreatgrid1[11, ii].Value.ToString() , proceduretreatgrid1[15, ii].Value.ToString(), Cmb_Doctor.SelectedValue.ToString() , proceduretreatgrid1[14, ii].Value.ToString() , proceduretreatgrid1[13, ii].Value.ToString() );
            //           this.cntrl.update_treatment_status(proceduretreatgrid1[14, ii].Value.ToString());
            //            string dt1 = DateTime.Now.Date.ToString("yyyy-MM-dd");
            //            DateTime Timeonly = DateTime.Now;
            //            this.cntrl.save_log(doctor_id, "Finished Procedure", " Add Finished Procedure", dt1, Convert.ToString(Timeonly.ToString("hh:mm tt")), "Add");
            //        }
            //        if (checkBoxReview.Checked == true)
            //        {
            //            this.cntrl.update_review(dateTimeReview.Value.ToString("yyyy-MM-dd HH:mm"), j_Review);
