...
namespace PappyjoeMVC.View
{
    public partial class Prescription_Add : Form
    {
        ...
        Clinical_Findings_controller cfcntrl = new Clinical_Findings_controller();
            ...
            try
            {
                ...
                else
                {
                    if (drugnametextbox.Text != "")
                    {
                        ...
                        bool ge = false;
                        if (chk_generic.Checked == true)
                        {
                            ge = true;
                        }
                        DataTable dt4 = this.cntrl.drug_load(ge);
                        string strstock = "";
        ...
        private void searchtext1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == (Keys.Back))
            {
                if (searchtext1.Text == "")
                {
                    dt4 = this.cntrl.drug_load(ge);

                }
                else
                {
                    dt4 = this.cntrl.drug_search(searchtext1.Text, ge);
            ...
            for (int j = 0; j < dt4.Rows.Count; j++)
            {
                if (ge == true)
                {
                    if (dt4.Rows[j]["generic"].ToString().TrimEnd() != "")
                    {
                        if (dt4.Rows[j]["inventory_id"].ToString() == "0")
                        {
                            //chk_exp /*=*/ "0";
                        ...
                        //{
                            presdruggrid.Rows.Add(dt4.Rows[j]["id"].ToString(), dt4.Rows[j]["name"].ToString(), dt4.Rows[j]["type"].ToString() + "  " + strstock);
                            int row = presdruggrid.Rows.Count;
                            if (strstock == "(Not sold)")
                            { presdruggrid.Rows[row - 1].Cells[2].Style.ForeColor = Color.Red; }
                            else if (strstock == "(Out-of-stock)")
                            { presdruggrid.Rows[row - 1].Cells[2].Style.ForeColor = Color.Blue; }
                            presdruggrid.Rows[row - 1].Cells[2].Style.Alignment = DataGridViewContentAlignment.MiddleRight;
                        //}
        ...
        private void addtemplatebut_Click(object sender, EventArgs e)
        {
            ...
            var form2 = new PappyjoeMVC.View.Pescriptiontemplate();
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (drugnametext.Text != "")
                {
                    ...
                    if(numericUpDownMorning.Value==0)
                    {
                        mrng = "";
                    }
                    else
                    {
                        mrng = numericUpDownMorning.Value.ToString();
                    }
                    if (numericUpDownNoon.Value == 0)
                    {
                        noon = "";
                    }
                    else
                    {
                        noon = numericUpDownNoon.Value.ToString();
                    }
                    if (numericUpDownNight.Value == 0)
                    {
                        night = "";
                    }
                    else
                    {
                        night = numericUpDownNight.Value.ToString();
                    }
                    ...
                    {
                        durat = numericUpDownDuration.Value.ToString();
                    }

                    dataGridView_drugnew.Rows.Add(drugnametext.Text, txtStrengthno.Text, strengthcombo.Text, durat, dur, mrng,noon,night, food, Note, id1, drug_type);// , , numericUpDownNight.Value, 
                    dataGridView_drugnew.Rows[dataGridView_drugnew.Rows.Count - 1].Cells[12].Value = PappyjoeMVC.Properties.Resources.deleteicon;
                    dataGridView_drugnew.Rows[dataGridView_drugnew.Rows.Count - 1].Height = 30;
                    img.ImageLayout = DataGridViewImageCellLayout.Normal;
            ...
            try
            {
                ...
                if (savebut.Text == "SAVE PRESCRIPTION")
                {
                    ...
                    if (dataGridView_drugnew.Rows.Count > 0)
                    {
                        ...
                        this.cntrl.save_log(doctor_id, "Prescription Add", "Add Prescription Add", dt1, Convert.ToString(Timeonly.ToString("hh:mm tt")), "Add", presid.ToString());
                ...
                else if (savebut.Text == "UPDATE PRESCRIPTION")
                {
                    if (dataGridView_drugnew.Rows.Count > 0)
                    {
                        ...
                        if (dt0 != "")
                        {
                            ...
                            DateTime Timeonly = DateTime.Now;
                            this.cntrl.save_log(doctor_id, "Prescription Add", " Edit Prescription Add", dt, Convert.ToString(Timeonly.ToString("hh:mm tt")), "Edit", presid.ToString());
                            var form2 = new Prescription_Show();
                            form2.doctor_id = doctor_id;
                            form2.patient_id = patient_id;
                            //Prescription_Show_controller controller = new Prescription_Show_controller(form2);
        ...
        private void chk_generic_CheckedChanged(object sender, EventArgs e)
        {
            bool ge = false;
            if (chk_generic.Checked == true)
            {
            ...
            for (int j = 0; j < dt4.Rows.Count; j++)
            {
                if (ge == true)
                {
                    string gene = dt4.Rows[j]["generic"].ToString();
                    if (dt4.Rows[j]["generic"].ToString().TrimEnd() != "")
                    {
                        if (dt4.Rows[j]["inventory_id"].ToString() == "0")
                        {
            ...
            try
            {
                if (panel_addtemplate.Visible != true)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        if(ge==true)
                        {
                            drugnametext.Text = dt.Rows[0]["generic"].ToString();
        ...
        private void fillclinicGrid()
        {
            ...
            string heading = "";
            System.Data.DataTable dt_cf_main = this.cfcntrl.dt_cf_main(patient_id);
            int i = 0;
            for (int j = 0; j < dt_cf_main.Rows.Count; j++)
            {
                ...
                System.Data.DataTable dt_cf_Complaints = this.cfcntrl.dt_cf_Complaints(dt_cf_main.Rows[j]["id"].ToString());
                ...
                System.Data.DataTable dt_cf_observe = this.cfcntrl.dt_cf_observe(dt_cf_main.Rows[j]["id"].ToString());
                ...
                System.Data.DataTable dt_cf_investigation = this.cfcntrl.dt_cf_investigation(dt_cf_main.Rows[j]["id"].ToString());
                ...
                System.Data.DataTable dt_cf_diagnosis = this.cfcntrl.dt_cf_diagnosis(dt_cf_main.Rows[j]["id"].ToString());
                ...
                System.Data.DataTable dt_cf_note = this.cfcntrl.dt_cf_note(dt_cf_main.Rows[j]["id"].ToString());
                ...
                System.Data.DataTable dt_cf_allergy = this.cfcntrl.dt_cf_allergy(dt_cf_main.Rows[j]["id"].ToString());
                ...
                System.Data.DataTable dt_cf_Nursenote = this.cfcntrl.dt_cf_Nursenote(dt_cf_main.Rows[j]["id"].ToString());
                ...
                System.Data.DataTable dt_cf_medical = this.cfcntrl.get_medicalId(patient_id);
                ...
                System.Data.DataTable dt_cf_medication = this.cfcntrl.dt_cf_meditation(dt_cf_main.Rows[j]["id"].ToString());
                ...
                System.Data.DataTable dt_cf_advice = this.cfcntrl.dt_cf_advice(dt_cf_main.Rows[j]["id"].ToString());
            ...
            {
                int x = (pnl_clinicFinding.Size.Width - Lbl_NoRecordFound_Alert.Size.Width) / 2;
        ...
        {
            dgvAllergy.ColumnCount = 5;
            dgvAllergy.RowCount = 0;
            dgvAllergy.ColumnHeadersVisible = false;
            dgvAllergy.RowHeadersVisible = false;
            dgvAllergy.Columns[4].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            string heading = "";
            System.Data.DataTable dt_cf_main = this.cfcntrl.dt_cf_main(patient_id);
            int i = 0;
            for (int j = 0; j < dt_cf_main.Rows.Count; j++)
            {
                dgvAllergy.Rows.Add(dt_cf_main.Rows[j]["id"].ToString(), String.Format("{0:dddd, MMMM d, yyyy}", Convert.ToDateTime(dt_cf_main.Rows[j]["date"].ToString())), "", "", "");
                dgvAllergy.Rows[i].Cells[4].Value = PappyjoeMVC.Properties.Resources.Bill;
                dgvAllergy.Rows[i].Cells[1].Style.Font = new System.Drawing.Font("Segoe UI", 7, FontStyle.Bold);
                dgvAllergy.Rows[i].Cells[1].Style.ForeColor = Color.DarkGreen;
                dgvAllergy.Rows[i].Cells[1].Style.BackColor = Color.LightGray;
                dgvAllergy.Rows[i].Cells[2].Style.BackColor = Color.LightGray;
                dgvAllergy.Rows[i].Cells[3].Style.BackColor = Color.LightGray;
                dgvAllergy.Rows[i].Cells[4].Style.BackColor = Color.LightGray;
                System.Data.DataTable dt_cf_allergy = this.cfcntrl.dt_cf_allergy(dt_cf_main.Rows[j]["id"].ToString());
                if (dt_cf_allergy.Rows.Count > 0)
                {
                    i = i + 1;
                    dgvAllergy.Rows.Add("0", "", "", "", "");
                    dgvAllergy.Rows[i].Height = 1;
                    dgvAllergy.Rows[i].Cells[3].Style.BackColor = Color.Gainsboro;
                    dgvAllergy.Rows[i].Cells[4].Value = PappyjoeMVC.Properties.Resources.blank;
                    int partLength = 90;
                    string sentence = dt_cf_allergy.Rows[0]["allergy_name"].ToString();
                    string[] words = sentence.Split(' ');
                    var parts = new Dictionary<int, string>();
                    ...
                    {
                        i = i + 1;
                        dgvAllergy.Rows.Add("0", heading, "", item.Value, "");
                        heading = "";
                        dgvAllergy.Rows[i].Cells[2].Style.BackColor = Color.Gainsboro;
                        dgvAllergy.Rows[i].Cells[4].Value = PappyjoeMVC.Properties.Resources.blank;
                    }
                    for (int k = 1; k < dt_cf_allergy.Rows.Count; k++)
                    {
                        ...
                        {
                            i = i + 1;
                            dgvAllergy.Rows.Add("0", "", "", item.Value, "");
                            dgvAllergy.Rows[i].Cells[4].Value = PappyjoeMVC.Properties.Resources.blank;
                            dgvAllergy.Rows[i].Cells[2].Style.BackColor = Color.Gainsboro;
                        }
                    }
                ...
                i = i + 1;
                dgvAllergy.Rows.Add("0", "Note by Dr." + dt_cf_main.Rows[j]["doctor_name"].ToString(), "", "", "");
                dgvAllergy.Rows[i].Cells[1].Style.ForeColor = Color.Red;
                dgvAllergy.Rows[i].Cells[1].Style.Font = new System.Drawing.Font("Segoe UI", 7, FontStyle.Bold);
                dgvAllergy.Rows[i].Cells[4].Value = PappyjoeMVC.Properties.Resources.blank;
                i = i + 1;
                dgvAllergy.Rows.Add("0", "", "", "", "");
            ...
            if (dgvAllergy.Rows.Count <= 0)
            {
                int x = (pnlAllergy.Size.Width - lbNoAllergy.Size.Width) / 2;
                lbNoAllergy.Location = new Point(x, lbNoAllergy.Location.Y);
                lbNoAllergy.Show();
            }
            else
            {
