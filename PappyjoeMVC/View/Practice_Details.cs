...
namespace PappyjoeMVC.View
{
    public partial class Practice_Details : Form
    {
        ...
        Download_Excel_Format excel_format = new Download_Excel_Format();
        ...
        private void PracticeDetails_Load(object sender, EventArgs e)
        {
            ...
            {
                button_practicestaff.Location = new Point(2, 75);
                button_printout.Location = new Point(2, 111);
                button_idgenerator.Location = new Point(2, 147);
                backuprestore.Location = new Point(2, 183);
                button_billing.Visible = false;
                button_calendar.Visible = false;
                button_communication.Visible = false;
                button_contacts.Visible = false;
                button_emr.Visible = false;
                button_importexport.Visible = false;
                button_medicalhistory.Visible = false;
                button_prescription.Visible = false;
                button_procedurecatalog.Visible = false;
                btnLab.Visible = false;
                //backuprestore.Visible = false;
                btnPrescriptionLang.Visible = false; btn_downloadexcelformat.Visible = false;
                btn_Inventory.Visible = false; button_communication.Visible = true;
            }
            else
            {
            ...
            //    button_importexport.Enabled = false;
            //    //focus = true;
            //    label16.Hide();
            //    panel_main.Visible = false;
            //    string docnam = this.cntrl.Get_DoctorName(doctor_id);
        ...
        public void backColor_change()
        {
            ...
            btn_downloadexcelformat.BackColor = Color.DodgerBlue;
        }
        ...
        private void btn_downloadexcelformat_Click(object sender, EventArgs e)
        {
            errorProvider1.Dispose();
            backColor_change();
            btn_downloadexcelformat.BackColor = Color.SteelBlue;
            form_hide();
            excel_format.TopLevel = false;
            panel_main.Controls.Add(excel_format);
            excel_format.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
            excel_format.Show();
        }
    }
}
