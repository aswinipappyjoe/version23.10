...
namespace PappyjoeMVC.View
{
    public partial class Printout : Form
    {
        ...
        string includeheader="",header, lefttext, righttext, includelogo, logotype, left1text, right1text;
        ...
        private void btnSave_InvFooter_Click(object sender, EventArgs e)
        {
            DataTable dtb = this.cntrl.Get_inventory_id();
            if (dtb.Rows.Count > 0)
            {
                int i = this.cntrl.Update_invPrint(combo_paper_size.Text, orientation, color, combo_topmargin.Text, combo_leftmargin.Text, combo_bottommargin.Text, combo_rightmargin.Text, includeheader, txtHeader.Text, txtSubHeading1.Text, txtSubHeading2.Text, includelogo, logotype, patientdetails, medhistory, patientno, address, phone, email, bloodgroup, genderdob, combo_footer_topmargin.Text, txtFooter.Text, txtSubFtr1.Text, txtSubFtr2.Text);
                if (i > 0)
                {
            ...
            {
                int i = this.cntrl.save_invPrint(combo_paper_size.Text, orientation, color, combo_topmargin.Text, combo_leftmargin.Text, combo_bottommargin.Text, combo_rightmargin.Text, includeheader, txtHeader.Text, txtSubHeading1.Text, txtSubHeading2.Text, includelogo, logotype, patientdetails, medhistory, patientno, address, phone, email, bloodgroup, genderdob, combo_footer_topmargin.Text, txtFooter.Text, txtSubFtr1.Text, txtSubFtr2.Text);
                if (i > 0)
                {
        ...
        private void btnSave_InvHeader_Click(object sender, EventArgs e)
        {
            DataTable dtb = this.cntrl.Get_inventory_id();
            if (dtb.Rows.Count > 0)
            {
           ...
           try
            {
                ...
                if (radio_headeryes1.Checked == true)
                {
                    ...
                    left1text = txt_left1.Text;
                    right1text = txt_right1.Text;
                ...
                if (count == 0)
                {
                    int insert = this.cntrl.save_invoice(combo_paper_size1.Text, orientation, color, combo_topmargin1.Text, combo_leftmargin1.Text, combo_bottommargin1.Text, combo_rightmargin1.Text, includeheader, header, lefttext, righttext, left1text, right1text, includelogo, logotype, patientdetails, medhistory, patientno, address, phone, email, bloodgroup, genderdob, combo_footer_topmargin1.Text, rich_fullwidth1.Text, rich_leftsign1.Text, rich_rightsign1.Text);
                    MessageBox.Show("Successfully Saved !!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void printDocument_invoice_PrintPage(object sender, PrintPageEventArgs e)
        {
            try
            {
                ...
                { 
                    ...
                    using (System.Drawing.Font printFont = new System.Drawing.Font("Arial", 16.0f))
                    {
                        e.Graphics.DrawString(text_header1.Text, printFont, Brushes.Gray, xx, 60);//70
                    }
                    using (System.Drawing.Font printFont = new System.Drawing.Font("Arial", 12.0f))
                    {
                        e.Graphics.DrawString(text_left_text1.Text, printFont, Brushes.Gray, xx, 90);//100
                    }
                    using (System.Drawing.Font printFont = new System.Drawing.Font("Arial", 10.0f))
                    {
                        e.Graphics.DrawString(text_right_text1.Text, printFont, Brushes.Gray, xx, 110);//120
                    }
                    using (System.Drawing.Font printFont = new System.Drawing.Font("Arial", 10.0f))//
                    {
                        e.Graphics.DrawString(txt_left1.Text, printFont, Brushes.Gray, xx, 130);
                    }
                    using (System.Drawing.Font printFont = new System.Drawing.Font("Arial", 10.0f))//
                    {
                        e.Graphics.DrawString(txt_right1.Text, printFont, Brushes.Gray, xx, 150);
                    }
                }
        ...
        private void printout_Load(object sender, EventArgs e)
        {
            try//
            {
                ...
                if (PappyjoeMVC.Model.Connection.MyGlobals.project_type.TrimEnd() == "Pharmacy")
                {
                    ...
                    DataTable dtb_inventory = this.cntrl.Get_inventory_id();
                    Load_Inventoryprint(dtb_inventory);
                }
                else
                {
                ...
                tabControl6.TabPages.Remove(tabInvFooter);
        ...
        public void Load_Inventoryprint(DataTable Inv_print)
        {
            if (Inv_print.Rows.Count > 0)
            {
                
                txtHeader.Text = Inv_print.Rows[0]["header"].ToString();
                txtSubHeading1.Text = Inv_print.Rows[0]["left_text"].ToString();
                txtSubHeading2.Text = Inv_print.Rows[0]["right_text"].ToString();
                txtFooter.Text = Inv_print.Rows[0]["fullwidth_context"].ToString();
                txtSubFtr1.Text = Inv_print.Rows[0]["left_sign"].ToString();
                txtSubFtr2.Text = Inv_print.Rows[0]["right_sign"].ToString();
            }
        }
    }
}
