            ...
            try {
                ...
                if (dtb_Receipt.Rows.Count > 0)
                {
                    for (int i = 0; i < dtb_Receipt.Rows.Count; i++)
                    {
                        ...
                        DgvReceiptReceivedPerDoctor.Rows[i].Cells["amount_paid"].Value = Convert.ToDecimal(dtb_Receipt.Rows[i]["amount_paid"].ToString()).ToString("0.00");
                        DgvReceiptReceivedPerDoctor.Rows[i].Cells["amount_due"].Value = Convert.ToDecimal(dtb_Receipt.Rows[i]["DUE AFTER PAYMENT"].ToString()).ToString("0.00");
                        ...
                        if (dtb.Rows.Count > 0)
                        {
                            DgvReceiptReceivedPerDoctor.Rows[i].Cells["cost"].Value = Convert.ToDecimal(dtb.Rows[0]["Total Cost"].ToString()).ToString("0.00");// totlcost;
                                                                                                                                                                //DgvReceiptReceivedPerDoctor.Rows[i].Cells["Discount_insr"].Value = discount;
                            if (dtb.Rows[0]["discountin_rs"].ToString() != "0")
                            {
                                DgvReceiptReceivedPerDoctor.Rows[i].Cells["Discount_insr"].Value = Convert.ToDecimal(dtb.Rows[0]["discountin_rs"].ToString()).ToString("0.00");
                                //discount = decimal.Parse(dt_inv.Rows[i]["discountin_rs"].ToString());
                            }
                            else
                            {
                                DgvReceiptReceivedPerDoctor.Rows[i].Cells["Discount_insr"].Value = "0.00";
                                //discount = 0;
                            }
                            DgvReceiptReceivedPerDoctor.Rows[i].Cells["tax_inrs"].Value = Convert.ToDecimal(dtb.Rows[0]["tax_inrs"].ToString()).ToString("0.00"); // tax;
                            DgvReceiptReceivedPerDoctor.Rows[i].Cells["income"].Value = Convert.ToDecimal(dtb.Rows[0]["Total Income"].ToString()).ToString("0.00");
                        }
                        else
                        {
                            DgvReceiptReceivedPerDoctor.Rows[i].Cells["cost"].Value = "0.00";// totlcost;
                                                                                              //DgvReceiptReceivedPerDoctor.Rows[i].Cells
                            DgvReceiptReceivedPerDoctor.Rows[i].Cells["Discount_insr"].Value = "0.00";
                            DgvReceiptReceivedPerDoctor.Rows[i].Cells["tax_inrs"].Value = "0.00"; // tax;
                            DgvReceiptReceivedPerDoctor.Rows[i].Cells["income"].Value = "0.00";
                        }
                    ...
                    for (int j = 0; j < DgvReceiptReceivedPerDoctor.Rows.Count; j++)
                    {
                        ...
                        Totalamount = Totalamount + Convert.ToDecimal(DgvReceiptReceivedPerDoctor.Rows[j].Cells["cost"].Value);
            ...
            if (DgvReceiptReceivedPerDoctor.Rows.Count > 0)
            {
                ...
                sWrite.WriteLine("<table align=center width =900>");
                    ...
                    if (DgvReceiptReceivedPerDoctor.Rows.Count > 0)
                    {
                        ...
                        sWrite.WriteLine("<td align='left' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2></font></td>");
                        sWrite.WriteLine("<td align='left' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2></font></td>");
                        sWrite.WriteLine("<td align='left' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2><b>Total</b></font></td>");
