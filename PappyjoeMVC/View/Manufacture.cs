...
namespace PappyjoeMVC.View
{
    public partial class Manufacture : Form
    {
        ...
        public static string id; int man_name = 0; int man_id = 0; int man_phn = 0;
            ...
            if (txt_Code.Text != "" && txt_name.Text != "" && txt_phone.Text != "")
            {
                if (btn_Save.Text == "UPDATE")
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        Fill_grid(dt);
                        MessageBox.Show("Manufacture updated successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                {
                    DataTable maname = this.cntrl.manufacture_name(txt_name.Text);
                    if (maname.Rows.Count <= 0)
                    {
                        man_name = 1;
                    }
                    else
                    ...
                    DataTable mancode = this.cntrl.manufacture_code(txt_Code.Text);
                    if (mancode.Rows.Count <= 0)
                    {
                        man_id = 1;
                    }
                    else
                    ...
                    DataTable manphn = this.cntrl.manufacture_code(txt_phone.Text);
                    if (mancode.Rows.Count <= 0)
                    {
                        man_phn = 1;
                    }
                    ...
                    if (man_id == 1 && man_name == 1 && man_phn == 1)
                    {
                        if (btn_Save.Text == "SAVE")
                        {
                            ...
                            if (i > 0)
                            {
                                DataTable dtb = this.cntrl.Load_grid();
                                Fill_grid(dtb);
                                MessageBox.Show("Manufacture saved successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        MessageBox.Show("Data already exists...", "Duplication Encountered", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        txt_Code.Focus();
                    }
                }
        ...
        {
            DataTable dt = this.cntrl.search_mnfctr(txt_search.Text);
            if (dt.Rows.Count > 0)
            {
                Dgv_Manufacture.Rows.Clear();
                int num = 1;
