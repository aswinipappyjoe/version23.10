...
namespace PappyjoeMVC.View
{
    public partial class Supplier : Form
    {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(txtSupplierName.Text) && !string.IsNullOrWhiteSpace(txtPhone.Text) && !string.IsNullOrWhiteSpace(txtContactPerson.Text) && !string.IsNullOrWhiteSpace(txtOB.Text))
                {
                    if (btnSaveSupplier.Text != "UPDATE SUPPLIER")
                    {
                        ...
                        {
                            int i = this.cntrl.Save(txtSupplierCode.Text, txtSupplierName.Text, txtContactPerson.Text, txtPhone.Text, txtphone2.Text, txtEmail.Text, txt_fax.Text, txtWeb.Text, txtAddress1.Text, txtaddress2.Text, txtAddresss3.Text, txtOB.Text,"Supplier",txt_advance.Text,txt_due.Text);
                        ...
                        {
                            MessageBox.Show("Supplier already exists...", "Duplication Encountered", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            txtSupplierName.Focus();
                        }
                    }
                    else
                    {
                        this.cntrl.update(id, txtSupplierCode.Text, txtSupplierName.Text, txtContactPerson.Text, txtPhone.Text, txtphone2.Text, txtEmail.Text, txt_fax.Text, txtWeb.Text, txtAddress1.Text, txtaddress2.Text, txtAddresss3.Text, txtOB.Text, txt_advance.Text,txt_due.Text);
                        btnSaveSupplier.Text = "Save Supplier";
        ...
        public void Fill_SuplierDetails(DataTable dt)
        {
            try
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    txt_advance.Text = dt.Rows[0]["advance"].ToString();
                    txt_due.Text = dt.Rows[0]["Current_Balance"].ToString();
        ...
        public void Clear()
        {
            ...
            txtaddress2.Text = "";
            txtAddresss3.Text = "";
            txtOB.Text = ""; txt_advance.Text = "";txt_due.Text = "";
        }
        ...
        private void txt_search_TextChanged(object sender, EventArgs e)
        {
                ...
                DataTable dt = this.cntrl.search_suplier(txt_search.Text);
                if (dt.Rows.Count > 0)
                {
