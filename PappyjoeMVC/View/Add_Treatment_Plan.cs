    ...
    public partial class Add_Treatment_Plan : Form
    {
        ...
        private void proceduretreatgrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                tottext.Text = Convert.ToString(Convert.ToDecimal(dt.Rows[0][1].ToString()));//round of
        ...
        private void costtextbox_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    a = Convert.ToDecimal(costtextbox.Text);
                }
        ...
        private void btn_TreatmentAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cqgrant.Text = String.Format("{0:C0}", totalcost);// totalcost.ToString("0.00"); // 
                    text_discounttotal.Text = String.Format("{0:C0}", totaldiscount);// totaldiscount.ToString("0.00"); //  
                    totgrant.Text = String.Format("{0:C0}", totalgrand);// totalgrand.ToString("0.00"); // 
        ...
        private void savebut_Click(object sender, EventArgs e)
        {
                    ...
                    try
                    {
                        ...
                        for (int ii = 0; ii < DGV_Procedure.Rows.Count; ii++)
                        {
                            if (DGV_Procedure.Rows[ii].Cells["nursenote"].Value.ToString() == "Yes")
                            {
                                ...
                                k= completed_id;
                                this.cntrl.save_completed_items_trans(k, patient_id, DGV_Procedure[0, ii].Value.ToString(), DGV_Procedure[1, ii].Value.ToString(), DGV_Procedure[2, ii].Value.ToString(), DGV_Procedure[3, ii].Value.ToString(), DGV_Procedure[5, ii].Value.ToString(), DGV_Procedure[4, ii].Value.ToString(), DGV_Procedure[6, ii].Value.ToString(), DGV_Procedure[7, ii].Value.ToString(), DGV_Procedure[11, ii].Value.ToString(), DTP_Date.Value.ToString("yyyy-MM-dd"), Cmb_Doctor.SelectedValue.ToString(), j.ToString(), DGV_Procedure[15, ii].Value.ToString(), "Yes", con, trans);
                        ...
                        if (flag == true)
                        {
                            ...
                            this.cntrl.save_log(doctor_id, "Finished Procedure", " Add Finished Procedure", dt11, Convert.ToString(Timeonl.ToString("hh:mm tt")), "Add", k.ToString());
            ...
            //                if (DGV_Procedure.Rows[ii].Cells["nursenote"].Value.ToString() == "Yes")
            //                {
            //                    this.cntrl.Save_treatmentgrid_set_ststus(j, DGV_Procedure[0, ii].Value.ToString(), patient_id, DGV_Procedure[1, ii].Value.ToString(), DGV_Procedure[2, ii].Value.ToString(), DGV_Procedure[3, ii].Value.ToString(), DGV_Procedure[5, ii].Value.ToString(), DGV_Procedure[4, ii].Value.ToString(), DGV_Procedure[6, ii].Value.ToString(), DGV_Procedure[7, ii].Value.ToString(), DGV_Procedure[11, ii].Value.ToString(), DGV_Procedure[13, ii].Value.ToString(), con, trans);
            //                    this.cntrl.save_completed_id_trans(DTP_Date.Value.ToString("yyyy-MM-dd"), patient_id, con, trans);
            //                    string maxid = this.cntrl.get_completedMaxid_trans(con, trans);
            //                    string treat_id = this.cntrl.get_treatmentplan_id(maxid, DGV_Procedure[0, ii].Value.ToString(), patient_id, con, trans);
            //                    int completed_id;
            ...
            //                    }
            //                    j = completed_id;
            //                    this.cntrl.save_completed_items_trans(j, patient_id, DGV_Procedure[0, ii].Value.ToString(), DGV_Procedure[1, ii].Value.ToString(), DGV_Procedure[2, ii].Value.ToString(), DGV_Procedure[3, ii].Value.ToString(), DGV_Procedure[5, ii].Value.ToString(), DGV_Procedure[4, ii].Value.ToString(), DGV_Procedure[6, ii].Value.ToString(), DGV_Procedure[7, ii].Value.ToString(), DGV_Procedure[11, ii].Value.ToString(), DTP_Date.Value.ToString("yyyy-MM-dd"), Cmb_Doctor.SelectedValue.ToString(), DGV_Procedure[14, ii].Value.ToString(), DGV_Procedure[13, ii].Value.ToString(), con, trans));
            //            //                              plan_main_id, patient_id, procedure_id,                      procedure_name,                           quantity,                              cost,                               discount_type,                             discount,                        total,                                    discount_inrs,                           note,                                date,                                     dr_id,                             completed_id,                            tooth
            //        }
            //                    else
            //        {
            //            this.cntrl.Save_treatmentgrid(j, DGV_Procedure[0, ii].Value.ToString(), patient_id, DGV_Procedure[1, ii].Value.ToString(), DGV_Procedure[2, ii].Value.ToString(), DGV_Procedure[3, ii].Value.ToString(), DGV_Procedure[5, ii].Value.ToString(), DGV_Procedure[4, ii].Value.ToString(), DGV_Procedure[6, ii].Value.ToString(), DGV_Procedure[7, ii].Value.ToString(), DGV_Procedure[11, ii].Value.ToString(), DGV_Procedure[13, ii].Value.ToString(), con, trans);
            //            //j,                                procedure_id,                          pt_id,          procedure_name,                      quantity,                          cost,                                      discount_type,                         discount,                           total,                               discount_inrs,                             note,                                     tooth,con,trans
            //        }
            //    }
            ////    trans.Commit();
            //    con.Close();
            //    string dt1 = DateTime.Now.Date.ToString("yyyy-MM-dd");
            //    DateTime Timeonly = DateTime.Now;
            //    this.cntrl.save_log(doctor_id, "Treatment Plan", " Add Treatment Plan", dt1, Convert.ToString(Timeonly.ToString("hh:mm tt")), "Add");
