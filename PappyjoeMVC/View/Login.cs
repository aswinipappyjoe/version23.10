    ...
    public partial class Login : Form
    {
       ...
       //int nHeightEllipse // width of ellipse
        ...
        private void Login_Load(object sender, EventArgs e)
        {
            ...
            Load_Login(dtb);
            Lab_version.Text = PappyjoeMVC.Model.GlobalVariables.Version;
        }
        ...
        public void Load_Login(DataTable choice)
        {
            try
            {
                ...
                string user_name = (string)regKey.GetValue("username");
                DataTable dt_type = db.table("select * from tbl_pappyjoe_settings");
                if (dt_type.Rows.Count > 0)
                {
                    PappyjoeMVC.Model.Connection.MyGlobals.project_type = dt_type.Rows[0]["project_type"].ToString();
                }
                if (choice.Rows.Count > 0)
                {
                    ...
                    if (user_name != null)
                    {
                        txt_userName.Text = user_name.ToString();
                    }
                    if (regdate1 == "")
                    {
                        ...
                        if (choice.Rows[0]["getcode"].ToString() == GetMacAddress())
                        {
                            ...
                            if (sd.Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    panel1.Show();
                                    panel1.Location = new System.Drawing.Point(24, 65);
                                    panel2.Hide();
                                }
                            }
                        }
                ...
                if (sd.Rows.Count > 0)
                {
                    ...
                    if (doctor.Rows.Count > 0)
                    {
                        if (doctor.Rows[0]["activate_login"].ToString() == "Yes")
                        {
                            ...
                            var form2 = new PappyjoeMVC.View.MainForm();
        ...
        private void lb_supportTicket_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://support.pappyjoe.com/open.php");
        }

        private void pb_web_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.pappyjoe.com/");
        }

        private void pb_twitter_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://twitter.com/pappyjoe_india");
        }

        private void pb_fb_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.facebook.com/pappyjoeindia/");
        }

        private void pb_insta_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.instagram.com/pappyjoe_india/");
        }

        private void pb_youtube_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.youtube.com/channel/UCUqNoTxL0-nySAAUeFPtMww");
        }
