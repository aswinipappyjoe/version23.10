...
namespace PappyjoeMVC.View
{
    public partial class Add_Receipt : Form
    {
        ...
        public bool fasttrack_flag = false;
        public Add_Receipt()
        {
            InitializeComponent();
        }
        private void Add_receipt_Load(object sender, EventArgs e)
        {
            ...
            {  
                ...
                //toolStripButton8.ToolTipTex     txt_PayNow.Focus();                                   
                ...
                {
                    label_availeble_advance.Text = string.Format("{0:C2}", Convert.ToDecimal(dtadvance.Rows[0][0].ToString()));
                    Lab_advance_Available.Text = string.Format("{0:C2}", Convert.ToDecimal(dtadvance.Rows[0][0].ToString()));
                    advanceamt = dtadvance.Rows[0][0].ToString();
                }
                else
                {
                    label_availeble_advance.Text = string.Format("{0:C2}", 0);
                    Lab_advance_Available.Text = string.Format("{0:C2}", 0);
                }
                decimal d = 0; 
                d = total - advance;
                lab_due_after_advance.Text = string.Format("{0:C2}", Convert.ToDecimal(d.ToString())); 
                txt_pay_from_advance.Text = string.Format("{0:C2}", 0);
                        ...
                        if (dt1.Rows.Count > 0)
                        {
                            ...
                            try
                            {
                                ...
                                if (DGV_MainGrid.Visible == true)
                                {
                                    ...
                                    lab_total_payable.Text = string.Format("{0:C2}", tot);
                                    Lab_TotalPayable.Text = string.Format("{0:C2}", tot) + " due";
                                }
                            }
                            catch (Exception ex)
                            {
        ...
        private void DGV_Invoice_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1 && e.ColumnIndex != -1)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        if (flag3 == 0)
                        {
                            ...
                            {
                                //DGV_MainGrid.Rows.Add(dt2.Rows[l][0].ToString(), dt2.Rows[l][1].ToString(), dt2.Rows[l][2].ToString(), 0, dt2.Rows[l][2].ToString(), due_after_payment, rowindex, dt2.Rows[l][0].ToString(), dt2.Rows[l][1].ToString(), dt2.Rows[l][2].ToString());
                                DGV_MainGrid.Rows.Add(dt2.Rows[l]["invoice_no"].ToString(), dt2.Rows[l]["services"].ToString(), dt2.Rows[l]["total"].ToString(), 0, dt2.Rows[l]["total"].ToString(), due_after_payment, rowindex, dt2.Rows[l]["invoice_no"].ToString(), dt2.Rows[l]["services"].ToString(), dt2.Rows[l]["total"].ToString());
                                l++;
                            }
                        }
                    }
                    ...
                    if (DGV_MainGrid.Visible == true)
                    {
                        ...
                        lab_total_payable.Text = string.Format("{0:C2}", Convert.ToDecimal(tot1.ToString()));
                        txt_pay_from_advance.Text = string.Format("{0:C2}", Convert.ToDecimal(advB.ToString()));
                        lab_due_after_advance.Text = string.Format("{0:C2}", Convert.ToDecimal(tot1 - advB));
                    }
                }
                catch (Exception ex)
                {
                ...
                if (DGV_MainGrid.Columns.Contains(""))
                {
            ...
            try
            {
                if (Convert.ToDecimal(rows_GridView3.ToString()) >= 0)
                {
                    ...
                    if (DGV_MainGrid.Rows[ro].Cells[3].Value.ToString() != "0" && DGV_MainGrid.Rows[ro].Cells[4].Value.ToString() != "0")
                    {
                        ...
                        txt_pay_from_advance.Text = string.Format("{0:C2}", Convert.ToDecimal(sumadvance.ToString()));
                        lab_due_after_advance.Text = string.Format("{0:C2}", Convert.ToDecimal((tot - sumadvance).ToString()));
                    }
            ...
            try
            {
                if (panel_advanced_payment.Visible == true)
                {
                    if (txt_PayNow.Text != "")
                    {
                        ...
                        if (adv > 0)
                        {
                            label_availeble_advance.Text = string.Format("{0:C2}", Convert.ToDecimal(adv.ToString()));
                            Lab_advance_Available.Text = string.Format("{0:C2}", Convert.ToDecimal(adv.ToString()));
                        }
                        txt_PayNow.Clear();
                        string dt = DateTime.Now.Date.ToString("yyyy-MM-dd");
                        DateTime Timeonly = DateTime.Now;
                        //this.cntrl.save_log(doctor_id, "Receipt", " Adds Receipt", dt, Convert.ToString(Timeonly.ToString("hh:mm tt")), "Add"); later log
                ...
                else if (DGV_MainGrid.Visible == true)
                {
                    ...
                    if (receipt.Rows.Count <= 0)
                    {
                        ...
                        if (calc())
                        {
                            while (i < DGV_MainGrid.Rows.Count)
                            {
                                if (DGV_MainGrid[3, i].Value.ToString() != "0" || DGV_MainGrid[4, i].Value.ToString() != "0")
                                {
                                    ...
                                    DataTable dt_due_clear = this.cntrl.dt_due_clear(DGV_MainGrid[7, i].Value.ToString(), patient_id);
                                    if (Cmb_Flag)
                                    {
                                        //update due amount in invoice tble
                                        ...
                                        if (updateinvoice > 0)
                                        {
                                            if(dt_due_clear.Rows.Count>0)//update due amount in payment table
                                            {
                                                this.cntrl.update_due(total, DGV_MainGrid[7, i].Value.ToString(), patient_id);
                                            }
                                            int inv = 0;
                                            ...
                                            {
                                                //inv = this.cntrl.Save_payment_DD(DGV_MainGrid[3, i].Value.ToString(), txt_ReceiptNo.Text.ToString(), totalPaid, DGV_MainGrid[7, i].Value.ToString(), DGV_MainGrid[8, i].Value.ToString(), Cmb_ModeOfPaymnt.Text, patient_id, dateTimePicker1.Value.ToString("yyyy-MM-dd"), Doctor_Name, total, totalinv.Rows[0]["total"].ToString(), totalinv.Rows[0]["cost"].ToString(), totalinv.Rows[0]["pt_name"].ToString(), txt_BankNAme.Text, txt_Number.Text, totalinv.Rows[0]["invoice_main_id"].ToString());
                                            }
                                            if (inv > 0)
                                            {
                                                int ii = 0;
                                    ...
                                    else
                                    {
                                        ...
                                        if (updateinvoice > 0)//totalinv.Rows[0]["total"].ToString()
                                        {
                                            //int inv1 = this.cntrl.save_payment(adv.ToString(), txt_ReceiptNo.Text.ToString(), totalPaid, DGV_MainGrid[7, i].Value.ToString(), DGV_MainGrid[8, i].Value.ToString(), Cmb_ModeOfPaymnt.Text, patient_id, dateTimePicker1.Value.ToString("yyyy-MM-dd"), Doctor_Name, totalinv.Rows[0]["invoice_main_id"].ToString(), total.ToString(), totalinv.Rows[0]["cost"].ToString(), totalinv.Rows[0]["pt_name"].ToString());
                                            int inv1 = this.cntrl.save_payment(adv.ToString(), txt_ReceiptNo.Text.ToString(), totalPaid, DGV_MainGrid[7, i].Value.ToString(), DGV_MainGrid[8, i].Value.ToString(), Cmb_ModeOfPaymnt.Text, patient_id, dateTimePicker1.Value.ToString("yyyy-MM-dd"), Doctor_Name, total, Convert.ToDecimal( totalinv.Rows[0]["total"].ToString()),  totalinv.Rows[0]["cost"].ToString(), totalinv.Rows[0]["pt_name"].ToString(), totalinv.Rows[0]["invoice_main_id"].ToString());
                                            {
                                                int ii = 0;
                                                decimal invoicepaymenttotal = 1;
                                                decimal invoice_main_id = 0;
                        ...
                        if (status == 1)
                        {
                            ...
                            if(fasttrack_flag==true)
                            {
                                var form2 = new Fasttrack_window_New();// Consultation(txtpatname.Text, id);
        ...
        public void LoadGrid_status0(DataTable dt1)
        {
            try
            {
                ...
                for (int j = 0; j < dt1.Rows.Count; j++)
                {
                    ...
                    {
                        DGV_Invoice.Rows[dict[items[0]]].Cells[3].Value += "\r\n" + String.Format("{0:C2}", Convert.ToDecimal(items4[1]));
                        DGV_Invoice.Rows[dict[items[0]]].Cells[1].Value += "\r\n" + items1[1];
                    }
                    else
                    {
                        dict.Add(items[0], rowNum);
                        DGV_Invoice.Rows.Add(items[1], items1[1], items2[1], String.Format("{0:C2}", Convert.ToDecimal(items4[1])), items3[1], items5[1]);
                        rowNum++;
                    }
                    due = due + decimal.Parse(dt1.Rows[j]["total"].ToString());
                    if (due > 0)
                    {
                        Lab_TotalPayable.Text = string.Format("{0:C2}", due) + " due";
                    }
                }
                DGV_Invoice.Columns[3].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                DGV_Invoice.Columns[5].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                ...
                try
                {
                    if (index != -1 && flag3 == 1)
                    {
                        if (DGV_MainGrid.Rows[e.RowIndex].Cells[e.ColumnIndex] is DataGridViewLinkCell)
                        {
                            ...
                            lab_total_payable.Text = string.Format("{0:C2}", Convert.ToDecimal(tot.ToString()));
                            txt_pay_from_advance.Text = string.Format("{0:C2}", Convert.ToDecimal(advB.ToString()));
                            lab_due_after_advance.Text = string.Format("{0:C2}", Convert.ToDecimal(tot - advB));
                        }
                    }
                }
                catch (Exception ex)
            ...
            try
            {
                ...
                try
                {
                    ...
                    else if (DGV_MainGrid.Rows[ro].Cells[3].Value.ToString() != "0" && DGV_MainGrid.Rows[ro].Cells[4].Value.ToString() == "0")
                    {
                        ...
                        while (i < DGV_MainGrid.Rows.Count)
                        {
                            sumadvance = sumadvance + Convert.ToDecimal(DGV_MainGrid[3, i].Value.ToString());
                            sumamountpay = sumamountpay + Convert.ToDecimal(DGV_MainGrid[4, i].Value.ToString());
                            totalamount = totalamount + Convert.ToDecimal(DGV_MainGrid[5, i].Value.ToString());
                            tot = tot + Convert.ToDecimal(DGV_MainGrid[2, i].Value.ToString());
                            i++;
                        }
                        txt_pay_from_advance.Text = string.Format("{0:C2}", Convert.ToDecimal(sumadvance.ToString()));
                        lab_due_after_advance.Text = string.Format("{0:C2}", Convert.ToDecimal((tot - sumadvance).ToString()));
                    ...
                    {
                        decimal sumadvance = 0, sumamountpay = 0, totalamount = 0, tot = 0;
                        DGV_MainGrid.Rows[ro].Cells[5].Value = Convert.ToDecimal(DGV_MainGrid.Rows[ro].Cells[2].Value.ToString()) - decimal.Parse(DGV_MainGrid.Rows[ro].Cells[4].Value.ToString());
                        int i = 0;
                        while (i < DGV_MainGrid.Rows.Count)
                        {
                            sumadvance = sumadvance + Convert.ToDecimal(DGV_MainGrid[3, i].Value.ToString());
                            ...
                            if (updateinvoice > 0)
                            {
                                ...
                                if (inv > 0)
                                {
                                    ...
                                    if (invocetotal.Rows.Count > 0)
                                    {
                                        ...
                                        while (ii < invocetotal.Rows.Count)
                                        {
                                            invoicepaymenttotal = invoicepaymenttotal + Convert.ToDecimal(invocetotal.Rows[0]["I_total"].ToString());
                                            ii++;
                                        }
                                    }
                                    if (invoicepaymenttotal == 0)
