    ...
    public partial class SimpleAppointment : Form
    {
        ...
        private void listpatientsearch_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (dtb.Rows.Count > 0)
            {
                ...
                txtAge.Text = dtb.Rows[0]["age"].ToString()+ dtb.Rows[0]["days"].ToString();
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            if (dgv_treatment.Rows.Count > 0)
            {
               ...
               this.cntrl.save_completed_id(dpStartTimeDate.Value.ToString("yyyy-MM-dd"), patient_id);
                ...
                {
                    this.cntrl.Save_tbl_completed_procedures(j1 , patient_id ,dgv_treatment.Rows[ii].Cells["treatmentid"].Value.ToString() , dgv_treatment.Rows[ii].Cells["treatement"].Value.ToString() , dgv_treatment.Rows[ii].Cells["_Unit"].Value.ToString(), dgv_treatment.Rows[ii].Cells["_Cost"].Value.ToString() , dgv_treatment.Rows[ii].Cells["dis_type"].Value.ToString() , dgv_treatment.Rows[ii].Cells["_Dis"].Value.ToString() , dgv_treatment.Rows[ii].Cells["Coltotalcost"].Value.ToString(), dgv_treatment.Rows[ii].Cells["_Dis_inrs"].Value.ToString() ,"",dr_id ,"0","","No");
                }
                //ReviewDate
        ...
        public void mprintosave()
        {
            ...
            string Pname = "", Gender = "", address = "", city = "", age = "",days="", Mobile = "";
            string str_p_as = "";
            string P_id = "";
            if (patient.Rows.Count > 0)
            {
                ...
                if (txtAge.Text != "")
                {
                    ...
                    if (str_p_as != "")
                    {
                        str_p_as = str_p_as + "/" + age + patient.Rows[0]["days"].ToString();
                    }
                    else
                    { str_p_as = "/" + age + patient.Rows[0]["days"].ToString(); }
                }
            }
            string str_name = "";
