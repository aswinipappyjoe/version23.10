...
namespace PappyjoeMVC.View
{
    public partial class Doctor_Profile : Form
    {
        ...
        public string status = "No"; //public static Color FromName(string name);
        public Doctor_Profile()
        {
            InitializeComponent();
        }
        public Doctor_Profile(string type)
        {
            InitializeComponent();
        ...
        private void Doctor_Profile_Load(object sender, EventArgs e)
        {
            ...
            if (PappyjoeMVC.Model.Connection.MyGlobals.loginType != "staff")
            {
                ...
                {
                    button1.BackColor = Color.FromArgb(190, 162, 232);// Color.PaleVioletRed;// Color.FromArgb(0, 192, 0, 192);
                }
                else if (colo == "9")
                {
                ...
                name.Rows[0]["login_type"].ToString();
                try
                {
        ...
        private void radio_login_yes_Click(object sender, EventArgs e)
        {
        ...
        {
            if (r_female.Checked == true)
                r_male.Checked = false;
            else if (r_male.Checked == true)
                r_female.Checked = false;
        }

        private void r_no_CheckedChanged(object sender, EventArgs e)
        {
            if (r_no.Checked == true)
                r_yes.Checked = false;
            else if (r_yes.Checked == true)
                r_no.Checked = false;
        }
