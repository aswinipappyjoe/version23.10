    ...
    public partial class Paymode_Wise_Receipt : Form
    {
        ...
        public void fillDGV_Receipt(DataTable dtb_Receipt, string d1, string d2)
        {
            try
            {
                ...
                {
                    decimal T_cash = 0, t_check = 0, t_dd = 0, t_card = 0, t_neft = 0, t_upi = 0, t_wallet = 0, t_other = 0;
                    for (int i = 0; i < dtb_Receipt.Rows.Count; i++)
                    {
                        ...
                        Dgv_Receipt.Rows[i].Cells["ColamountPaid"].Value = Convert.ToDecimal(dtb_Receipt.Rows[i]["amount_paid"].ToString()).ToString("0.00");
                        Dgv_Receipt.Rows[i].Cells["colTAmountDue"].Value = Convert.ToDecimal(dtb_Receipt.Rows[i]["Total Amount Due"].ToString()).ToString("0.00");
                        ...
                        Dgv_Receipt.Rows[i].Cells["COl4Digit"].Value = dtb_Receipt.Rows[i]["4DigitNo"].ToString();
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            Dgv_Receipt.Rows[i].Cells["ColTotalCost"].Value = Convert.ToDecimal(dt.Rows[0]["Total Cost"].ToString()).ToString("0.00");// totlcost;
                            Dgv_Receipt.Rows[i].Cells["ColTAmount"].Value = Convert.ToDecimal(dt.Rows[0]["Total Income"].ToString()).ToString("0.00");// totlincome;
                        }
                        else
                        {
                            Dgv_Receipt.Rows[i].Cells["ColTotalCost"].Value = "0.00";
                            Dgv_Receipt.Rows[i].Cells["ColTAmount"].Value = "0.00";
                    ...
                    {
                        Totalamount = Totalamount + Convert.ToDecimal(Dgv_Receipt.Rows[j].Cells["ColTotalCost"].Value);
                        ...
                        if(Dgv_Receipt.Rows[j].Cells["ColModeOfPayment"].Value.ToString().Trim()== "Cash")
                        {
                            T_cash= T_cash+ Convert.ToDecimal(Dgv_Receipt.Rows[j].Cells["ColamountPaid"].Value);
                        }
                        else if (Dgv_Receipt.Rows[j].Cells["ColModeOfPayment"].Value.ToString().Trim() == "Cheque")
                        {
                            t_check= t_check + Convert.ToDecimal(Dgv_Receipt.Rows[j].Cells["ColamountPaid"].Value);
                        }
                        else if (Dgv_Receipt.Rows[j].Cells["ColModeOfPayment"].Value.ToString().Trim() == "Card")
                        {
                            t_card = t_card + Convert.ToDecimal(Dgv_Receipt.Rows[j].Cells["ColamountPaid"].Value);
                        }
                        else if (Dgv_Receipt.Rows[j].Cells["ColModeOfPayment"].Value.ToString().Trim() == "Demand Draft")
                        {
                            t_dd = t_dd + Convert.ToDecimal(Dgv_Receipt.Rows[j].Cells["ColamountPaid"].Value);
                        }
                        else if (Dgv_Receipt.Rows[j].Cells["ColModeOfPayment"].Value.ToString().Trim() == "NEFT/RTGS/IMPS")
                        {
                            t_neft = t_neft + Convert.ToDecimal(Dgv_Receipt.Rows[j].Cells["ColamountPaid"].Value);
                        }
                        else if (Dgv_Receipt.Rows[j].Cells["ColModeOfPayment"].Value.ToString().Trim() == "Wallets")
                        {
                            t_wallet = t_wallet + Convert.ToDecimal(Dgv_Receipt.Rows[j].Cells["ColamountPaid"].Value);
                        }
                        else if (Dgv_Receipt.Rows[j].Cells["ColModeOfPayment"].Value.ToString().Trim() == "UPI")
                        {
                            t_upi = t_upi + Convert.ToDecimal(Dgv_Receipt.Rows[j].Cells["ColamountPaid"].Value);
                        }
                        else if (Dgv_Receipt.Rows[j].Cells["ColModeOfPayment"].Value.ToString().Trim() == "Other")
                        {
                            t_other = t_other + Convert.ToDecimal(Dgv_Receipt.Rows[j].Cells["ColamountPaid"].Value);
                        }
                    }
                    ...
                    l_tcash.Text = Convert.ToDecimal(T_cash).ToString("#0.00");
                    cheque.Text = Convert.ToDecimal(t_check).ToString("#0.00");
                    card.Text = Convert.ToDecimal(t_card).ToString("#0.00");
                    dd.Text = Convert.ToDecimal(t_dd).ToString("#0.00");
                    nef.Text = Convert.ToDecimal(t_neft).ToString("#0.00");
                    wallet.Text = Convert.ToDecimal(t_wallet).ToString("#0.00");
                    upi.Text = Convert.ToDecimal(t_upi).ToString("#0.00");
                    others.Text = Convert.ToDecimal(t_other).ToString("#0.00");
                }
                else
                {
            ...
            try
            {
                if (Dgv_Receipt.Rows.Count > 0)
                {
                    ...
                    if (Dgv_Receipt.Rows.Count > 0)
                    {
                        ...
                        { sWrite.WriteLine("    <td align='right' width='40' style='border:1px solid #000;background:#999999'><FONT COLOR=black  FACE='Segoe UI' SIZE=3><b>Amount Due</b>&nbsp;</font></td>"); }
                        sWrite.WriteLine("</tr>");
                        ...
                        sWrite.WriteLine("<div>");
                        sWrite.WriteLine("<table align='left' style='width:200;border: 1px ;border-collapse: collapse;'>");
                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI'SIZE=2><b>Cash</font></b></td>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI' SIZE=2><b>" + l_tcash.Text + "</b></font></td>");
                        sWrite.WriteLine("</tr>");

                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI'SIZE=2><b>Cheque</font></b></td>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI' SIZE=2><b>" + cheque.Text + "</b></font></td>");
                        sWrite.WriteLine("</tr>");

                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI'SIZE=2><b>Card</font></b></td>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI' SIZE=2><b>" + card.Text + "</b></font></td>");
                        sWrite.WriteLine("</tr>");

                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI'SIZE=2><b>DD</font></b></td>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI' SIZE=2><b>" + dd.Text + "</b></font></td>");
                        sWrite.WriteLine("</tr>");

                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI'SIZE=2><b>NFE</font></b></td>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI' SIZE=2><b>" + nef.Text + "</b></font></td>");
                        sWrite.WriteLine("</tr>");

                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI'SIZE=2><b>Wallet</font></b></td>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI' SIZE=2><b>" + wallet.Text + "</b></font></td>");
                        sWrite.WriteLine("</tr>");

                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI'SIZE=2><b>UPI</font></b></td>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI' SIZE=2><b>" + upi.Text + "</b></font></td>");
                        sWrite.WriteLine("</tr>");

                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI'SIZE=2><b>Others</font></b></td>");
                        sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black  FACE='Segoe UI' SIZE=2><b>" + others.Text + "</b></font></td>");
                        sWrite.WriteLine("</tr>");
